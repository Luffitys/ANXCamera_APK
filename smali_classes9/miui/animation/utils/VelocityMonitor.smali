...
.method private addAndUpdate(Lmiui/animation/utils/VelocityMonitor$MoveRecord;)V
    ...
    iget-object p1, p0, Lmiui/animation/utils/VelocityMonitor;->mHistory:Ljava/util/LinkedList;
...
.method private calVelocity(ILmiui/animation/utils/VelocityMonitor$MoveRecord;Lmiui/animation/utils/VelocityMonitor$MoveRecord;)F
    ...
    iget-wide v10, v0, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->timeStamp:J

    iget-object v0, v1, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->values:[D

    aget-wide v3, v0, p1

    iget-wide v0, v1, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->timeStamp:J
    ...
    iget-object v0, v7, Lmiui/animation/utils/VelocityMonitor;->mHistory:Ljava/util/LinkedList;
    ...
    iget-object v1, v7, Lmiui/animation/utils/VelocityMonitor;->mHistory:Ljava/util/LinkedList;
    ...
    check-cast v15, Lmiui/animation/utils/VelocityMonitor$MoveRecord;

    iget-wide v1, v15, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->timeStamp:J
    ...
    iget-object v0, v15, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->values:[D
    ...
    iget-object v0, v3, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->values:[D
...
.method private clearVelocity()V
    ...
    iget-object p0, p0, Lmiui/animation/utils/VelocityMonitor;->mVelocity:[F
...
.method private getMoveRecord()Lmiui/animation/utils/VelocityMonitor$MoveRecord;
    ...
    new-instance p0, Lmiui/animation/utils/VelocityMonitor$MoveRecord;

    const/4 v0, 0x0

    invoke-direct {p0, v0}, Lmiui/animation/utils/VelocityMonitor$MoveRecord;-><init>(Lmiui/animation/utils/VelocityMonitor$1;)V

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->timeStamp:J
...
.method private updateVelocity()V
    ...
    iget-object v3, p0, Lmiui/animation/utils/VelocityMonitor;->mHistory:Ljava/util/LinkedList;
    ...
    check-cast v0, Lmiui/animation/utils/VelocityMonitor$MoveRecord;

    iget-object v1, p0, Lmiui/animation/utils/VelocityMonitor;->mVelocity:[F

    if-eqz v1, :cond_0

    array-length v1, v1

    iget-object v3, v2, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->values:[D
    ...
    :cond_0
    iget-object v1, v2, Lmiui/animation/utils/VelocityMonitor$MoveRecord;->values:[D

    array-length v1, v1

    new-array v1, v1, [F

    iput-object v1, p0, Lmiui/animation/utils/VelocityMonitor;->mVelocity:[F
    ...
    invoke-direct {p0, v1, v2, v0}, Lmiui/animation/utils/VelocityMonitor;->calVelocity(ILmiui/animation/utils/VelocityMonitor$MoveRecord;Lmiui/animation/utils/VelocityMonitor$MoveRecord;)F
