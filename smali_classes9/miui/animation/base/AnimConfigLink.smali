...
.method private static canNotApply(Lmiui/animation/base/AnimConfig;Lmiui/animation/property/FloatProperty;)Z
    ...
    iget-object p0, p0, Lmiui/animation/base/AnimConfig;->relatedProperty:[Lmiui/animation/property/FloatProperty;

    invoke-static {p0, p1}, Lmiui/animation/utils/CommonUtils;->inArray([Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private static srcPreferProperty(Lmiui/animation/base/AnimConfig;Lmiui/animation/base/AnimConfig;)Z
    ...
    invoke-static {p0}, Lmiui/animation/utils/CommonUtils;->isArrayEmpty([Ljava/lang/Object;)Z

    move-result p0

    if-eqz p0, :cond_2

    iget-object p0, p1, Lmiui/animation/base/AnimConfig;->relatedProperty:[Lmiui/animation/property/FloatProperty;
...
.method public add(Lmiui/animation/base/AnimConfig;)V
    ...
    iget-object p0, p0, Lmiui/animation/base/AnimConfigLink;->configList:Ljava/util/List;

    new-instance v0, Lmiui/animation/base/AnimConfig;

    invoke-direct {v0, p1}, Lmiui/animation/base/AnimConfig;-><init>(Lmiui/animation/base/AnimConfig;)V
...
.method public add(Lmiui/animation/base/AnimConfigLink;)V
    ...
    :cond_0
    iget-object p1, p1, Lmiui/animation/base/AnimConfigLink;->configList:Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Lmiui/animation/base/AnimConfigLink;->add(Lmiui/animation/base/AnimConfig;)V
...
.method public getEase(Lmiui/animation/property/FloatProperty;)Lmiui/animation/utils/EaseManager$EaseStyle;
    ...
    iget-object v3, v2, Lmiui/animation/base/AnimConfig;->ease:Lmiui/animation/utils/EaseManager$EaseStyle;

    if-eqz v3, :cond_0

    iget-wide v3, v2, Lmiui/animation/base/AnimConfig;->effectFromValue:D
    ...
    invoke-static {v2, p1}, Lmiui/animation/base/AnimConfigLink;->canNotApply(Lmiui/animation/base/AnimConfig;Lmiui/animation/property/FloatProperty;)Z
    ...
    invoke-static {v1, v2}, Lmiui/animation/base/AnimConfigLink;->srcPreferProperty(Lmiui/animation/base/AnimConfig;Lmiui/animation/base/AnimConfig;)Z
    ...
    iget v3, v3, Lmiui/animation/utils/EaseManager$EaseStyle;->style:I

    invoke-static {v3}, Lmiui/animation/utils/EaseManager;->isPhysicsStyle(I)Z
    ...
    :cond_2
    iget-object v0, v2, Lmiui/animation/base/AnimConfig;->ease:Lmiui/animation/utils/EaseManager$EaseStyle;
...
.method public getEaseEffectFromValue(Lmiui/animation/property/FloatProperty;DD)Lmiui/animation/utils/EaseManager$EaseStyle;
    ...
    iget-object v1, v0, Lmiui/animation/base/AnimConfig;->ease:Lmiui/animation/utils/EaseManager$EaseStyle;

    if-eqz v1, :cond_0

    iget-wide v1, v0, Lmiui/animation/base/AnimConfig;->effectFromValue:D
    ...
    invoke-static {v0, p1}, Lmiui/animation/base/AnimConfigLink;->canNotApply(Lmiui/animation/base/AnimConfig;Lmiui/animation/property/FloatProperty;)Z
    ...
    iget-object p0, v0, Lmiui/animation/base/AnimConfig;->ease:Lmiui/animation/utils/EaseManager$EaseStyle;
