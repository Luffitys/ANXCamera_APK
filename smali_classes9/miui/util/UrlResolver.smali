...
.method private static checkMiuiIntent(Landroid/content/Context;ZLandroid/content/pm/PackageManager;Ljava/lang/Object;Landroid/content/Intent;Ljava/lang/String;ILjava/util/List;I)Landroid/content/pm/ResolveInfo;
    ...
    invoke-static {v11}, Lcom/miui/internal/util/UrlResolverHelper;->isWhiteListPackage(Ljava/lang/String;)Z
    ...
    :cond_9
    invoke-static {v8}, Lcom/miui/internal/util/UrlResolverHelper;->isMiHost(Ljava/lang/String;)Z
    ...
    :cond_a
    invoke-static {v6}, Lcom/miui/internal/util/UrlResolverHelper;->getFallbackParameter(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v9}, Lcom/miui/internal/util/UrlResolverHelper;->isBrowserFallbackScheme(Ljava/lang/String;)Z

    move-result v9

    if-eqz v9, :cond_b

    invoke-static {v6}, Lcom/miui/internal/util/UrlResolverHelper;->getBrowserFallbackUri(Ljava/lang/String;)Landroid/net/Uri;
    ...
    :cond_c
    invoke-static {p0, v1, v3}, Lmiui/util/UrlResolver;->checkMiuiIntent(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Landroid/content/pm/ResolveInfo;
    ...
    :try_start_1
    sget-object v1, Lmiui/util/UrlResolver;->mResolveIntent:Ljava/lang/reflect/Method;
