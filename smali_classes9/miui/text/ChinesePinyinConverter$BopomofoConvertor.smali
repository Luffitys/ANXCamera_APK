...
.method private static build()Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;
    ...
    iput-object v2, v0, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->output:Ljava/lang/String;
    ...
    :goto_0
    sget-object v5, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor;->sPinyinToZhuyin:[Ljava/lang/String;
    ...
    iget-object v10, v8, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->children:Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;

    :goto_2
    if-eqz v10, :cond_1

    iget-char v11, v10, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->ch:C

    if-eq v11, v9, :cond_1

    iget-object v10, v10, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->next:Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;
    ...
    iput-char v9, v10, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->ch:C

    iget-object v9, v8, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->children:Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;

    iput-object v9, v10, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->next:Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;

    iput-object v10, v8, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->children:Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;
    ...
    :cond_3
    iput-boolean v4, v8, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->specials:Z
    ...
    iput-object v5, v8, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->output:Ljava/lang/String;
...
.method private static convert(Ljava/lang/String;ILjava/lang/StringBuilder;)I
    ...
    iget-object v5, v1, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->output:Ljava/lang/String;

    if-eqz v5, :cond_2

    iget-boolean v5, v1, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->specials:Z
    ...
    iget-object p0, v2, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->output:Ljava/lang/String;
