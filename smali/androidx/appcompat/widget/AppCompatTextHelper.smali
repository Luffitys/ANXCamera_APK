...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v3, v0, v5, v1, v6}, Landroidx/appcompat/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;

    move-result-object v5

    sget v8, Landroidx/appcompat/R$styleable;->AppCompatTextHelper_android_textAppearance:I
    ...
    iput-object v10, v7, Landroidx/appcompat/widget/AppCompatTextHelper;->mDrawableLeftTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v10, v7, Landroidx/appcompat/widget/AppCompatTextHelper;->mDrawableTopTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v10, v7, Landroidx/appcompat/widget/AppCompatTextHelper;->mDrawableRightTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v10, v7, Landroidx/appcompat/widget/AppCompatTextHelper;->mDrawableBottomTint:Landroidx/appcompat/widget/TintInfo;
    ...
    invoke-static {v3, v8, v14}, Landroidx/appcompat/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;I[I)Landroidx/appcompat/widget/TintTypedArray;
    ...
    invoke-virtual {v8, v14}, Landroidx/appcompat/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v8, v14, v6}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    :goto_0
    invoke-direct {v7, v3, v8}, Landroidx/appcompat/widget/AppCompatTextHelper;->updateTypefaceAndStyle(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V

    if-ge v2, v12, :cond_a

    sget v11, Landroidx/appcompat/R$styleable;->TextAppearance_android_textColor:I

    invoke-virtual {v8, v11}, Landroidx/appcompat/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v8, v11}, Landroidx/appcompat/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v13}, Landroidx/appcompat/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v8, v13}, Landroidx/appcompat/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v12}, Landroidx/appcompat/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v8, v12}, Landroidx/appcompat/widget/TintTypedArray;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v10}, Landroidx/appcompat/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v8, v10}, Landroidx/appcompat/widget/TintTypedArray;->getString(I)Ljava/lang/String;
    ...
    invoke-static {v3, v0, v8, v1, v6}, Landroidx/appcompat/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;
    ...
    invoke-virtual {v8, v6}, Landroidx/appcompat/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v8, v6, v14}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {v8, v6}, Landroidx/appcompat/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v6}, Landroidx/appcompat/widget/TintTypedArray;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v6, v4}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v0, v2}, Landroid/widget/TextView;->setTextLocales(Landroid/os/LocaleList;)V
    ...
    invoke-virtual {v2, v0}, Landroid/widget/TextView;->setTextLocale(Ljava/util/Locale;)V
    ...
    invoke-virtual {v0, v2, v1}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v3, v2, v0}, Landroidx/appcompat/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/TintTypedArray;
    ...
    invoke-virtual {v2, v3, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
