...
.field private mObservers:Landroid/arch/core/b/c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>()V
    ...
    invoke-direct {v0}, Landroid/arch/core/b/c;-><init>()V

    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/core/b/c;
...
.method private dispatchingValue(Landroid/arch/lifecycle/LiveData$ObserverWrapper;)V
    ...
    :cond_2
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/core/b/c;

    invoke-virtual {v1}, Landroid/arch/core/b/c;->na()Landroid/arch/core/b/c$d;
...
.method public hasObservers()Z
    ...
    iget-object p0, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/core/b/c;
...
.method public observe(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Observer;)V
    ...
    invoke-virtual {p0, p2, v0}, Landroid/arch/core/b/c;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public observeForever(Landroid/arch/lifecycle/Observer;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/arch/core/b/c;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    instance-of p1, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;
    ...
    invoke-virtual {v0, p0}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->activeStateChanged(Z)V
...
.method protected postValue(Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Landroid/arch/lifecycle/LiveData;->mPostValueRunnable:Ljava/lang/Runnable;

    invoke-virtual {p1, p0}, Landroid/arch/core/a/c;->d(Ljava/lang/Runnable;)V
...
.method public removeObserver(Landroid/arch/lifecycle/Observer;)V
    ...
    invoke-virtual {p0, p1}, Landroid/arch/core/b/c;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public removeObservers(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/core/b/c;

    invoke-virtual {v0}, Landroid/arch/core/b/c;->iterator()Ljava/util/Iterator;
