...
.method protected setOctet(II)V
    ...
    invoke-direct {v0, v2}, Lcom/google/android/mms/InvalidHeaderValueException;-><init>(Ljava/lang/String;)V
    ...
    if-le p1, v0, :cond_103

    if-ge p1, v5, :cond_103
    ...
    if-le p1, v0, :cond_10c

    if-gt p1, v6, :cond_10c
    ...
    :cond_10c
    if-lt p1, v3, :cond_114

    if-le p1, v3, :cond_112

    if-lt p1, v4, :cond_114
    ...
    if-le p1, v0, :cond_120

    if-ge p1, v5, :cond_120
    ...
    if-le p1, v0, :cond_129

    if-gt p1, v6, :cond_129
    ...
    :cond_129
    if-lt p1, v3, :cond_131

    if-le p1, v3, :cond_12f

    if-lt p1, v4, :cond_131
