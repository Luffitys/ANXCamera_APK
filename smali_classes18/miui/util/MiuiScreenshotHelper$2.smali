.class Lmiui/util/MiuiScreenshotHelper$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lmiui/util/MiuiScreenshotHelper;->takeScreenshot(IZZJLandroid/os/Handler;Ljava/util/function/Consumer;)V
.end annotation
...
# direct methods
.method constructor <init>(Lmiui/util/MiuiScreenshotHelper;ILandroid/os/Handler;Ljava/lang/Runnable;Ljava/util/function/Consumer;ZZ)V
    .registers 8

    iput-object p1, p0, Lmiui/util/MiuiScreenshotHelper$2;->this$0:Lmiui/util/MiuiScreenshotHelper;

    iput p2, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$screenshotType:I

    iput-object p3, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$handler:Landroid/os/Handler;

    iput-object p4, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$mScreenshotTimeout:Ljava/lang/Runnable;

    iput-object p5, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$completionConsumer:Ljava/util/function/Consumer;

    iput-boolean p6, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$hasStatus:Z

    iput-boolean p7, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$hasNav:Z
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iget-object v0, p0, Lmiui/util/MiuiScreenshotHelper$2;->this$0:Lmiui/util/MiuiScreenshotHelper;
    ...
    :try_start_7
    iget-object v1, p0, Lmiui/util/MiuiScreenshotHelper$2;->this$0:Lmiui/util/MiuiScreenshotHelper;
    ...
    iget v2, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$screenshotType:I
    ...
    new-instance v5, Lmiui/util/MiuiScreenshotHelper$2$1;

    iget-object v6, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$handler:Landroid/os/Handler;

    invoke-virtual {v6}, Landroid/os/Handler;->getLooper()Landroid/os/Looper;

    move-result-object v6

    invoke-direct {v5, p0, v6, v4}, Lmiui/util/MiuiScreenshotHelper$2$1;-><init>(Lmiui/util/MiuiScreenshotHelper$2;Landroid/os/Looper;Landroid/content/ServiceConnection;)V
    ...
    iget-boolean v6, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$hasStatus:Z
    ...
    iget-boolean v6, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$hasNav:Z
    ...
    :try_end_43
    .catchall {:try_start_7 .. :try_end_43} :catchall_69
    ...
    iget-object v7, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$completionConsumer:Ljava/util/function/Consumer;
    ...
    monitor-exit v0
    :try_end_6b
    .catchall {:try_start_48 .. :try_end_6b} :catchall_69
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iget-object v2, p0, Lmiui/util/MiuiScreenshotHelper$2;->this$0:Lmiui/util/MiuiScreenshotHelper;
    ...
    iget-object v1, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$handler:Landroid/os/Handler;

    iget-object v2, p0, Lmiui/util/MiuiScreenshotHelper$2;->val$mScreenshotTimeout:Ljava/lang/Runnable;
