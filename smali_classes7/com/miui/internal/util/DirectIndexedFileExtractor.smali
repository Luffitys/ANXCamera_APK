...
.method private static extractDirectIndexedFile(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string p0, "directIndexedFilePath is null"
    ...
    const-string p0, " don\'t need overwrite"
    ...
    invoke-static {v4, p0}, Lmiui/os/FileUtils;->copyToFile(Ljava/io/InputStream;Ljava/io/File;)Z
    ...
    const-string p1, " extraction completed."
...
.method public static replaceDirectIndexedFile(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string p0, "replaceDirectIndexedFile srcPath is null"
    ...
    const-string p0, "replaceDirectIndexedFile destPath is null"
    ...
    invoke-static {v4, v0}, Lmiui/os/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;)Z
    ...
    const-string p2, "old idf file:%s delete fail"
    ...
    const-string p2, " copy and rename success."
    ...
    const-string p0, "%s copy or rename failed , tmp file delete: %s"
    ...
    const-string p1, "replaceDirectIndexedFile result is "
