...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mResources:Landroid/content/res/Resources;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mVisibleItems:Ljava/util/ArrayList;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mIsVisibleItemsStale:Z
    ...
    iput-boolean p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mIsActionItemsStale:Z
...
.method private addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    iget-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mCurrentMenuInfo:Landroid/view/ContextMenu$ContextMenuInfo;

    if-eqz p1, :cond_0

    invoke-virtual {v9, p1}, Lcom/miui/internal/view/menu/MenuItemImpl;->setMenuInfo(Landroid/view/ContextMenu$ContextMenuInfo;)V

    :cond_0
    iget-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;

    invoke-static {p1, v8}, Lcom/miui/internal/view/menu/MenuBuilder;->findInsertIndex(Ljava/util/ArrayList;I)I
...
.method private dispatchPresenterUpdate(Z)V
    ...
    iget-object v2, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method private dispatchSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method private setHeaderInternal(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    iput-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mHeaderTitle:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mHeaderIcon:Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    :goto_1
    iput-object v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mHeaderView:Landroid/view/View;
...
.method private setShortcutsVisibleInner(Z)V
    ...
    iget-object p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mResources:Landroid/content/res/Resources;
...
.method public addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    invoke-virtual {p1, p2}, Lcom/miui/internal/view/menu/MenuItemImpl;->setSubMenu(Lcom/miui/internal/view/menu/SubMenuBuilder;)V
...
.method final close(Z)V
    ...
    iget-boolean v0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mIsClosing:Z
    ...
    iput-boolean p1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mIsClosing:Z
...
.method dispatchMenuItemSelected(Lcom/miui/internal/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mCallback:Lcom/miui/internal/view/menu/MenuBuilder$Callback;

    if-eqz p0, :cond_0

    invoke-interface {p0, p1, p2}, Lcom/miui/internal/view/menu/MenuBuilder$Callback;->onMenuItemSelected(Lcom/miui/internal/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Lcom/miui/internal/view/menu/MenuItemImpl;
    ...
    iget-object v0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mTempShortcutItemList:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-virtual {p0, v0, p1, p2}, Lcom/miui/internal/view/menu/MenuBuilder;->findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
...
.method findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lcom/miui/internal/view/menu/MenuItemImpl;->hasSubMenu()Z

    move-result v5

    if-eqz v5, :cond_2

    invoke-virtual {v3}, Lcom/miui/internal/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;

    move-result-object v5

    check-cast v5, Lcom/miui/internal/view/menu/MenuBuilder;

    invoke-virtual {v5, p1, p2, p3}, Lcom/miui/internal/view/menu/MenuBuilder;->findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V

    :cond_2
    if-eqz v0, :cond_3

    invoke-virtual {v3}, Lcom/miui/internal/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    :cond_3
    invoke-virtual {v3}, Lcom/miui/internal/view/menu/MenuItemImpl;->getNumericShortcut()C
    ...
    :cond_4
    invoke-virtual {v3}, Lcom/miui/internal/view/menu/MenuItemImpl;->isEnabled()Z
...
.method public flagActionItems()V
    ...
    iget-boolean v0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mIsActionItemsStale:Z
    ...
    :cond_3
    iget-object v3, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
...
.method public getActionItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
...
.method public getContext()Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mContext:Landroid/content/Context;
...
.method public getExpandedItem()Lcom/miui/internal/view/menu/MenuItemImpl;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mExpandedItem:Lcom/miui/internal/view/menu/MenuItemImpl;
...
.method public getHeaderIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mHeaderIcon:Landroid/graphics/drawable/Drawable;
...
.method public getHeaderTitle()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mHeaderTitle:Ljava/lang/CharSequence;
...
.method public getHeaderView()Landroid/view/View;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mHeaderView:Landroid/view/View;
...
.method public getNonActionItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
...
.method getOptionalIconsVisible()Z
    ...
    iget-boolean p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mOptionalIconsVisible:Z
...
.method getResources()Landroid/content/res/Resources;
    ...
    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mResources:Landroid/content/res/Resources;
...
.method public getVisibleItems()Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mIsVisibleItemsStale:Z

    if-nez v0, :cond_0

    iget-object p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mVisibleItems:Ljava/util/ArrayList;

    return-object p0

    :cond_0
    iget-object v0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mVisibleItems:Ljava/util/ArrayList;
...
.method isQwertyMode()Z
    ...
    iget-boolean p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mQwertyMode:Z
...
.method public isShortcutsVisible()Z
    ...
    iget-boolean p0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mShortcutsVisible:Z
...
.method public performItemAction(Landroid/view/MenuItem;I)Z
    ...
    :goto_1
    invoke-virtual {p0, v3}, Lcom/miui/internal/view/menu/MenuBuilder;->close(Z)V
    ...
    :cond_6
    invoke-direct {p0, p1}, Lcom/miui/internal/view/menu/MenuBuilder;->dispatchSubMenuSelected(Lcom/miui/internal/view/menu/SubMenuBuilder;)Z
...
.method public performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, p2}, Lcom/miui/internal/view/menu/MenuBuilder;->close(Z)V
...
.method public removeGroup(I)V
    ...
    invoke-direct {p0, v0, v2}, Lcom/miui/internal/view/menu/MenuBuilder;->removeItemAtInt(IZ)V
...
.method public restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, p1}, Lcom/miui/internal/view/menu/MenuBuilder;->restoreActionViewStates(Landroid/os/Bundle;)V
...
.method public saveActionViewStates(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, p1}, Lcom/miui/internal/view/menu/MenuBuilder;->saveActionViewStates(Landroid/os/Bundle;)V
...
.method setExclusiveItemChecked(Landroid/view/MenuItem;)V
    ...
    invoke-virtual {v1}, Lcom/miui/internal/view/menu/MenuItemImpl;->isExclusiveCheckable()Z
    ...
    :cond_1
    invoke-virtual {v1}, Lcom/miui/internal/view/menu/MenuItemImpl;->isCheckable()Z
    ...
    :goto_1
    invoke-virtual {v1, v2}, Lcom/miui/internal/view/menu/MenuItemImpl;->setCheckedInt(Z)V
...
.method public startDispatchingItemsChanged()V
    ...
    iget-boolean v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mItemsChangedWhileDispatchPrevented:Z
