...
.method private constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Lcom/miui/internal/widget/ViewDragHelper$Callback;)V
    ...
    iput p3, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeSize:I

    invoke-virtual {p2}, Landroid/view/ViewConfiguration;->getScaledTouchSlop()I

    move-result p3

    iput p3, p0, Lcom/miui/internal/widget/ViewDragHelper;->mTouchSlop:I
    ...
    iput p3, p0, Lcom/miui/internal/widget/ViewDragHelper;->mMaxVelocity:F
    ...
    iput p2, p0, Lcom/miui/internal/widget/ViewDragHelper;->mMinVelocity:F

    new-instance p2, Landroid/widget/Scroller;

    sget-object p3, Lcom/miui/internal/widget/ViewDragHelper;->sInterpolator:Landroid/view/animation/Interpolator;
...
.method private checkNewEdgeDrag(FFII)Z
    ...
    iget v0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mTrackingEdges:I
    ...
    iget-object p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeDragsLocked:[I
    ...
    :cond_1
    iget-object p2, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeDragsInProgress:[I
    ...
    iget p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mTouchSlop:I
...
.method private checkTouchSlop(Landroid/view/View;FF)Z
    ...
    iget p3, p0, Lcom/miui/internal/widget/ViewDragHelper;->mTouchSlop:I
    ...
    iget p2, p0, Lcom/miui/internal/widget/ViewDragHelper;->mTouchSlop:I
...
.method private clearMotionHistory(I)V
    ...
    iput p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mPointersDown:I
...
.method private computeSettleDuration(Landroid/view/View;IIII)I
    ...
    invoke-direct {p0, p4, v0, v1}, Lcom/miui/internal/widget/ViewDragHelper;->clampMag(III)I
    ...
    invoke-direct {p0, p5, v0, v1}, Lcom/miui/internal/widget/ViewDragHelper;->clampMag(III)I
    ...
    invoke-direct {p0, p2, p4, v2}, Lcom/miui/internal/widget/ViewDragHelper;->computeAxisDuration(III)I
    ...
    invoke-direct {p0, p3, p5, p1}, Lcom/miui/internal/widget/ViewDragHelper;->computeAxisDuration(III)I
...
.method public static create(Landroid/view/ViewGroup;FLcom/miui/internal/widget/ViewDragHelper$Callback;)Lcom/miui/internal/widget/ViewDragHelper;
    ...
    iput p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mTouchSlop:I
...
.method private dispatchViewReleased(FF)V
    ...
    iput-boolean p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mReleaseInProgress:Z

    iget p2, p0, Lcom/miui/internal/widget/ViewDragHelper;->mDragState:I

    if-ne p2, v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/miui/internal/widget/ViewDragHelper;->setDragState(I)V
...
.method private dragTo(IIII)V
    ...
    iget-object v3, p0, Lcom/miui/internal/widget/ViewDragHelper;->mCapturedView:Landroid/view/View;
    ...
    iget-object p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mCapturedView:Landroid/view/View;
...
.method private ensureMotionHistorySizeForId(I)V
    ...
    iget-object v6, p0, Lcom/miui/internal/widget/ViewDragHelper;->mInitialMotionX:[F
    ...
    iget-object v6, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeDragsInProgress:[I

    array-length v7, v6

    invoke-static {v6, v8, v5, v8, v7}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v6, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeDragsLocked:[I
    ...
    iput-object p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeDragsLocked:[I
...
.method private forceSettleCapturedViewAt(IIII)Z
    ...
    invoke-direct/range {v4 .. v9}, Lcom/miui/internal/widget/ViewDragHelper;->computeSettleDuration(Landroid/view/View;IIII)I
...
.method private getEdgesTouched(II)I
    ...
    iget v1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeSize:I
    ...
    :cond_2
    iget-object p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mParentView:Landroid/view/ViewGroup;

    invoke-virtual {p1}, Landroid/view/ViewGroup;->getBottom()I

    move-result p1

    iget p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeSize:I
...
.method private reportNewEdgeDrags(FFI)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/miui/internal/widget/ViewDragHelper;->checkNewEdgeDrag(FFII)Z
    ...
    iget-object p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mEdgeDragsInProgress:[I
...
.method private saveInitialMotion(FFI)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/miui/internal/widget/ViewDragHelper;->getEdgesTouched(II)I

    move-result p1

    aput p1, v0, p3

    iget p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mPointersDown:I
...
.method public captureChildView(Landroid/view/View;I)V
    ...
    iget-object p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mParentView:Landroid/view/ViewGroup;
...
.method public checkTouchSlop(II)Z
    ...
    iget-object v4, p0, Lcom/miui/internal/widget/ViewDragHelper;->mInitialMotionX:[F
    ...
    iget-object v5, p0, Lcom/miui/internal/widget/ViewDragHelper;->mInitialMotionY:[F
...
.method public continueSettling(Z)Z
    ...
    iget-object v0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mSetIdleRunnable:Ljava/lang/Runnable;
    ...
    :cond_6
    :goto_0
    iget p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mDragState:I
...
.method public getCapturedView()Landroid/view/View;
    ...
    iget-object p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mCapturedView:Landroid/view/View;
...
.method public getMinVelocity()F
    ...
    iget p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mMinVelocity:F
...
.method public isEdgeTouched(II)Z
    ...
    iget-object p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mInitialEdgesTouched:[I
...
.method public isPointerDown(I)Z
    ...
    iget p0, p0, Lcom/miui/internal/widget/ViewDragHelper;->mPointersDown:I
...
.method public processTouchEvent(Landroid/view/MotionEvent;)V
    ...
    iget v1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mDragState:I
    ...
    iget-object v6, p0, Lcom/miui/internal/widget/ViewDragHelper;->mCapturedView:Landroid/view/View;

    if-ne v5, v6, :cond_4

    invoke-virtual {p0, v6, v4}, Lcom/miui/internal/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    :cond_6
    invoke-direct {p0, v0}, Lcom/miui/internal/widget/ViewDragHelper;->clearMotionHistory(I)V
    ...
    invoke-direct {p0, v2, p1, v0}, Lcom/miui/internal/widget/ViewDragHelper;->saveInitialMotion(FFI)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/miui/internal/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z

    iget-object p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mInitialEdgesTouched:[I

    aget p1, p1, v0

    iget v1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mTrackingEdges:I
    ...
    :cond_9
    iget p1, p0, Lcom/miui/internal/widget/ViewDragHelper;->mDragState:I

    if-ne p1, v3, :cond_12

    const/4 p1, 0x0

    invoke-direct {p0, p1, p1}, Lcom/miui/internal/widget/ViewDragHelper;->dispatchViewReleased(FF)V
    ...
    invoke-direct {p0, v0}, Lcom/miui/internal/widget/ViewDragHelper;->isValidPointerForActionMove(I)Z
    ...
    invoke-direct {p0, v2, v3, v1, v0}, Lcom/miui/internal/widget/ViewDragHelper;->dragTo(IIII)V
    ...
    invoke-direct {p0, v1}, Lcom/miui/internal/widget/ViewDragHelper;->isValidPointerForActionMove(I)Z
    ...
    invoke-direct {p0, v6, v7, v1}, Lcom/miui/internal/widget/ViewDragHelper;->reportNewEdgeDrags(FFI)V
    ...
    invoke-direct {p0, v4, v6, v7}, Lcom/miui/internal/widget/ViewDragHelper;->checkTouchSlop(Landroid/view/View;FF)Z

    move-result v5

    if-eqz v5, :cond_f

    invoke-virtual {p0, v4, v1}, Lcom/miui/internal/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/miui/internal/widget/ViewDragHelper;->saveInitialMotion(FFI)V

    invoke-virtual {p0, v2, p1}, Lcom/miui/internal/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
...
.method public shouldInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ViewDragHelper;->clearMotionHistory(I)V
    ...
    invoke-direct {p0, v5, p1, v0}, Lcom/miui/internal/widget/ViewDragHelper;->saveInitialMotion(FFI)V
    ...
    invoke-direct {p0, v3}, Lcom/miui/internal/widget/ViewDragHelper;->isValidPointerForActionMove(I)Z
    ...
    invoke-direct {p0, v7, v8, v3}, Lcom/miui/internal/widget/ViewDragHelper;->reportNewEdgeDrags(FFI)V
    ...
    invoke-direct {p0, v5, v7, v8}, Lcom/miui/internal/widget/ViewDragHelper;->checkTouchSlop(Landroid/view/View;FF)Z

    move-result v6

    if-eqz v6, :cond_8

    invoke-virtual {p0, v5, v3}, Lcom/miui/internal/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, v0, p1}, Lcom/miui/internal/widget/ViewDragHelper;->tryCaptureViewForDrag(Landroid/view/View;I)Z
...
.method public smoothSlideViewTo(Landroid/view/View;II)Z
    ...
    invoke-direct {p0, p2, p3, p1, p1}, Lcom/miui/internal/widget/ViewDragHelper;->forceSettleCapturedViewAt(IIII)Z
