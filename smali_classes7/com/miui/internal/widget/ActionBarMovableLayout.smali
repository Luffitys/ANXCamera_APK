...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mOverScrollDistance:I
    ...
    iput v1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScrollRange:I
    ...
    iput v1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTouchSlop:I

    new-instance v1, Landroid/widget/OverScroller;

    invoke-direct {v1, p1}, Landroid/widget/OverScroller;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScroller:Landroid/widget/OverScroller;

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result p1

    iput p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mMinimumVelocity:I

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity()I

    move-result p1

    iput p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mMaximumVelocity:I
...
.method private isTabViewVisibilityChanged()Z
    ...
    iget-object v0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTabScrollView:Landroid/view/View;
    ...
    iget v1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTabViewVisibility:I

    if-eq v0, v1, :cond_0

    iput v0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTabViewVisibility:I
...
.method private onSecondaryPointerUp(Landroid/view/MotionEvent;)V
    ...
    iput p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mActivePointerId:I

    iget-object p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mVelocityTracker:Landroid/view/VelocityTracker;
...
.method protected applyTranslationY(F)V
    ...
    iget-object p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTabScrollView:Landroid/view/View;
...
.method protected computeVerticalVelocity()I
    ...
    iget p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mActivePointerId:I
...
.method protected fling(I)V
    ...
    iput-boolean p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mFlinging:Z
...
.method public getOverScrollDistance()I
    ...
    iget p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mOverScrollDistance:I
...
.method public getScrollRange()I
    ...
    iget p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScrollRange:I
...
.method public getScrollStart()I
    ...
    iget p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScrollStart:I
...
.method protected measureChildWithMargins(Landroid/view/View;IIII)V
    ...
    iget-object v1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mActionBarView:Lcom/miui/internal/widget/ActionBarView;
...
.method protected motionToTranslation(F)F
    ...
    iget p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScrollRange:I

    int-to-float p1, p1

    sub-float/2addr v0, p1

    iget p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScrollStart:I
    ...
    iget-object p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTabScrollView:Landroid/view/View;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput v0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mActivePointerId:I
    ...
    iget-object p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScroller:Landroid/widget/OverScroller;

    invoke-virtual {p1, v3}, Landroid/widget/OverScroller;->forceFinished(Z)V

    :cond_6
    :goto_0
    iget-boolean p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mIsBeingDragged:Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mInitialMotionYSet:Z
    ...
    :goto_1
    iget-boolean p3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mInitialMotionYSet:Z

    if-nez p3, :cond_3

    iget p3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mInitialMotionY:I

    if-gez p3, :cond_2

    iget p3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mScrollRange:I

    iput p3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mInitialMotionY:I

    :cond_2
    iget p3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mInitialMotionY:I

    iput p3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mMotionY:I

    iput-boolean p2, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mInitialMotionYSet:Z

    :cond_3
    if-eqz p1, :cond_4

    iget p1, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mMotionY:I
...
.method protected onOverScrolled(IIZZ)V
    ...
    iget p3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mMinimumVelocity:I

    mul-int/lit8 p3, p3, 0x2

    if-le p2, p3, :cond_0

    iget-object p0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mOnScrollListener:Lmiui/app/ActionBar$OnScrollListener;
    ...
    invoke-interface {p0, p1, p2}, Lmiui/app/ActionBar$OnScrollListener;->onFling(FI)V
...
.method protected onScrollBegin()V
    ...
    invoke-interface {p0}, Lmiui/app/ActionBar$OnScrollListener;->onStartScroll()V
...
.method protected onScrollEnd()V
    ...
    invoke-interface {p0}, Lmiui/app/ActionBar$OnScrollListener;->onStopScroll()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v0, v10, Lcom/miui/internal/widget/ActionBarMovableLayout;->mMotionY:I

    if-nez v0, :cond_4

    iput-boolean v13, v10, Lcom/miui/internal/widget/ActionBarMovableLayout;->mIsBeingDragged:Z

    iput v14, v10, Lcom/miui/internal/widget/ActionBarMovableLayout;->mActivePointerId:I
    ...
    iput-boolean v12, v10, Lcom/miui/internal/widget/ActionBarMovableLayout;->mIsBeingDragged:Z
...
.method protected overScrollBy(IIIIIIIIZ)Z
    ...
    :goto_3
    invoke-virtual {p0, p9, p4, p9, p7}, Lcom/miui/internal/widget/ActionBarMovableLayout;->onOverScrolled(IIZZ)V
...
.method protected shouldStartScroll(Landroid/view/MotionEvent;)Z
    ...
    iget v0, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mActivePointerId:I
    ...
    sget-object p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->TAG:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mContentView:Landroid/view/View;

    float-to-int v6, v1

    float-to-int v7, p1

    invoke-direct {p0, v5, v6, v7}, Lcom/miui/internal/widget/ActionBarMovableLayout;->inChild(Landroid/view/View;II)Z

    move-result v5

    iget-object v8, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTabScrollView:Landroid/view/View;

    invoke-direct {p0, v8, v6, v7}, Lcom/miui/internal/widget/ActionBarMovableLayout;->inChild(Landroid/view/View;II)Z
    ...
    iget v5, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mTouchSlop:I

    if-le v3, v5, :cond_7

    if-le v3, v4, :cond_7

    iget v3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mMotionY:I
    ...
    :cond_4
    iget-object v3, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mOnScrollListener:Lmiui/app/ActionBar$OnScrollListener;
    ...
    :cond_8
    iput v2, p0, Lcom/miui/internal/widget/ActionBarMovableLayout;->mState:I
