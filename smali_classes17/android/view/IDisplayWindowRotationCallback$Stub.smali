...
# static fields
.field private static final DESCRIPTOR:Ljava/lang/String; = "android.view.IDisplayWindowRotationCallback"

.field static final TRANSACTION_continueRotateDisplay:I = 0x1
...
.method public static asInterface(Landroid/os/IBinder;)Landroid/view/IDisplayWindowRotationCallback;
    .registers 3
    ...
    check-cast v1, Landroid/view/IDisplayWindowRotationCallback;

    return-object v1

    :cond_14
    new-instance v1, Landroid/view/IDisplayWindowRotationCallback$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/view/IDisplayWindowRotationCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V

    return-object v1
.end method

.method public static getDefaultImpl()Landroid/view/IDisplayWindowRotationCallback;
    .registers 1
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_5
    const-string v0, "continueRotateDisplay"

    return-object v0
.end method

.method public static setDefaultImpl(Landroid/view/IDisplayWindowRotationCallback;)Z
    .registers 3
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_2a
    invoke-virtual {p0, v2, v3}, Landroid/view/IDisplayWindowRotationCallback$Stub;->continueRotateDisplay(ILandroid/window/WindowContainerTransaction;)V
