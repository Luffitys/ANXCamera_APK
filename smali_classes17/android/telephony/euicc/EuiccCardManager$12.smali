...
.method public onComplete(I[B)V
    ...
    :try_start_4
    iget-object v2, p0, Landroid/telephony/euicc/EuiccCardManager$12;->val$executor:Ljava/util/concurrent/Executor;

    iget-object v3, p0, Landroid/telephony/euicc/EuiccCardManager$12;->val$callback:Landroid/telephony/euicc/EuiccCardManager$ResultCallback;

    new-instance v4, Landroid/telephony/euicc/-$$Lambda$EuiccCardManager$12$0dAgJQ0nijxpb9xsSsFqNuBkchU;

    invoke-direct {v4, v3, p1, p2}, Landroid/telephony/euicc/-$$Lambda$EuiccCardManager$12$0dAgJQ0nijxpb9xsSsFqNuBkchU;-><init>(Landroid/telephony/euicc/EuiccCardManager$ResultCallback;I[B)V
