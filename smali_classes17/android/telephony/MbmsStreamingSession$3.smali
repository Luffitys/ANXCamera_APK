...
.method public onNullBinding(Landroid/content/ComponentName;)V
    ...
    # invokes: Landroid/telephony/MbmsStreamingSession;->sendErrorToApp(ILjava/lang/String;)V
    invoke-static {v0, v1, v2}, Landroid/telephony/MbmsStreamingSession;->access$100(Landroid/telephony/MbmsStreamingSession;ILjava/lang/String;)V

    # getter for: Landroid/telephony/MbmsStreamingSession;->sIsInitialized:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    # getter for: Landroid/telephony/MbmsStreamingSession;->mService:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    # getter for: Landroid/telephony/MbmsStreamingSession;->mContext:Landroid/content/Context;
    invoke-static {v0}, Landroid/telephony/MbmsStreamingSession;->access$600(Landroid/telephony/MbmsStreamingSession;)Landroid/content/Context;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    # getter for: Landroid/telephony/MbmsStreamingSession;->mInternalCallback:Landroid/telephony/mbms/InternalStreamingSessionCallback;
    ...
    # getter for: Landroid/telephony/MbmsStreamingSession;->mSubscriptionId:I
    ...
    # getter for: Landroid/telephony/MbmsStreamingSession;->mDeathRecipient:Landroid/os/IBinder$DeathRecipient;
