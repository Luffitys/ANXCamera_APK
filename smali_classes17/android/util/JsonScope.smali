...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v8}, Landroid/util/JsonScope;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v1, v9}, Landroid/util/JsonScope;-><init>(Ljava/lang/String;I)V

    sput-object v0, Landroid/util/JsonScope;->CLOSED:Landroid/util/JsonScope;

    const/16 v1, 0x8

    new-array v1, v1, [Landroid/util/JsonScope;

    sget-object v10, Landroid/util/JsonScope;->EMPTY_ARRAY:Landroid/util/JsonScope;

    aput-object v10, v1, v2

    sget-object v2, Landroid/util/JsonScope;->NONEMPTY_ARRAY:Landroid/util/JsonScope;
    ...
    sget-object v2, Landroid/util/JsonScope;->DANGLING_NAME:Landroid/util/JsonScope;

    aput-object v2, v1, v5

    sget-object v2, Landroid/util/JsonScope;->NONEMPTY_OBJECT:Landroid/util/JsonScope;
    ...
    sput-object v1, Landroid/util/JsonScope;->$VALUES:[Landroid/util/JsonScope;
