...
# static fields
.field private static final DESCRIPTOR:Ljava/lang/String; = "android.window.IWindowContainerTransactionCallback"
...
.method public static asInterface(Landroid/os/IBinder;)Landroid/window/IWindowContainerTransactionCallback;
    ...
    check-cast v1, Landroid/window/IWindowContainerTransactionCallback;

    return-object v1

    :cond_14
    new-instance v1, Landroid/window/IWindowContainerTransactionCallback$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/window/IWindowContainerTransactionCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V

    return-object v1
.end method

.method public static getDefaultImpl()Landroid/window/IWindowContainerTransactionCallback;
    .registers 1

    sget-object v0, Landroid/window/IWindowContainerTransactionCallback$Stub$Proxy;->sDefaultImpl:Landroid/window/IWindowContainerTransactionCallback;
...
.method public static setDefaultImpl(Landroid/window/IWindowContainerTransactionCallback;)Z
    .registers 3
    ...
    sput-object p0, Landroid/window/IWindowContainerTransactionCallback$Stub$Proxy;->sDefaultImpl:Landroid/window/IWindowContainerTransactionCallback;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_2a
    invoke-virtual {p0, v2, v3}, Landroid/window/IWindowContainerTransactionCallback$Stub;->onTransactionReady(ILandroid/view/SurfaceControl$Transaction;)V
