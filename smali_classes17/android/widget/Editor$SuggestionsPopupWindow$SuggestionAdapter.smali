...
.method private constructor <init>(Landroid/widget/Editor$SuggestionsPopupWindow;)V
    ...
    # getter for: Landroid/widget/Editor$SuggestionsPopupWindow;->mContext:Landroid/content/Context;
    invoke-static {p1}, Landroid/widget/Editor$SuggestionsPopupWindow;->access$4400(Landroid/widget/Editor$SuggestionsPopupWindow;)Landroid/content/Context;
...
.method public getCount()I
    ...
    invoke-static {v0}, Landroid/widget/Editor$SuggestionsPopupWindow;->access$4500(Landroid/widget/Editor$SuggestionsPopupWindow;)I
...
.method public getItem(I)Ljava/lang/Object;
    ...
    # getter for: Landroid/widget/Editor$SuggestionsPopupWindow;->mSuggestionInfos:[Landroid/widget/Editor$SuggestionInfo;
    invoke-static {v0}, Landroid/widget/Editor$SuggestionsPopupWindow;->access$4600(Landroid/widget/Editor$SuggestionsPopupWindow;)[Landroid/widget/Editor$SuggestionInfo;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    # getter for: Landroid/widget/Editor$SuggestionsPopupWindow;->mSuggestionInfos:[Landroid/widget/Editor$SuggestionInfo;
    invoke-static {v1}, Landroid/widget/Editor$SuggestionsPopupWindow;->access$4600(Landroid/widget/Editor$SuggestionsPopupWindow;)[Landroid/widget/Editor$SuggestionInfo;
