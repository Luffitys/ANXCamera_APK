...
.method public updatePosition(FF)V
    ...
    invoke-direct {p0, v1}, Landroid/widget/Editor$SelectionEndHandleView;->positionAndAdjustForCrossingHandles(I)V

    return-void

    :cond_1a
    iget v1, p0, Landroid/widget/Editor$SelectionEndHandleView;->mPreviousLineTouched:I
    ...
    iput v1, p0, Landroid/widget/Editor$SelectionEndHandleView;->mPreviousLineTouched:I
    ...
    iget v3, p0, Landroid/widget/Editor$SelectionEndHandleView;->mPreviousLineTouched:I

    invoke-virtual {v2, v0, v3, p2}, Landroid/widget/Editor;->getCurrentLineAdjustedForSlop(Landroid/text/Layout;IF)I
    ...
    :cond_57
    iput v2, p0, Landroid/widget/Editor$SelectionEndHandleView;->mPreviousLineTouched:I

    invoke-direct {p0, v3}, Landroid/widget/Editor$SelectionEndHandleView;->positionAndAdjustForCrossingHandles(I)V
...
.method public updateSelection(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/widget/Editor$SelectionEndHandleView;->updateDrawable(Z)V
