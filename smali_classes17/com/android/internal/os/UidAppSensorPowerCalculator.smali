.class public Lcom/android/internal/os/UidAppSensorPowerCalculator;
.super Ljava/lang/Object;
.source "UidAppSensorPowerCalculator.java"


# static fields
.field private static final DEBUG:Z = false

.field private static final TAG:Ljava/lang/String; = "UidAppSensorPowerCalculator"
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/BatteryStats;JI)V
    .registers 14

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/android/internal/os/UidAppSensorPowerCalculator;->mContext:Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/android/internal/os/UidAppSensorPowerCalculator;->mSensors:Ljava/util/List;

    new-instance v3, Lcom/android/internal/os/PowerProfile;

    iget-object v1, p0, Lcom/android/internal/os/UidAppSensorPowerCalculator;->mContext:Landroid/content/Context;

    invoke-direct {v3, v1}, Lcom/android/internal/os/PowerProfile;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/internal/os/UidAppSensorPowerCalculator;->getAverageGpsPower(Lcom/android/internal/os/PowerProfile;Landroid/os/BatteryStats;JI)D

    move-result-wide v1

    iput-wide v1, p0, Lcom/android/internal/os/UidAppSensorPowerCalculator;->mGpsPowerOn:D
...
.method public calculateUidApp(Lcom/android/internal/os/BatterySipper;Lcom/android/internal/os/UidAppBatteryStatsImpl$UidPackage;JI)V
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/android/internal/os/UidAppBatteryStatsImpl$UidPackage;->getSensorStats()Landroid/util/SparseArray;
    ...
    invoke-virtual {v5}, Lcom/android/internal/os/UidAppBatteryStatsImpl$UidPackage$Sensor;->getSensorTime()Lcom/android/internal/os/BatteryStatsImpl$Timer;
    ...
    iget-object v13, v0, Lcom/android/internal/os/UidAppSensorPowerCalculator;->mSensors:Ljava/util/List;
    ...
    iget-object v15, v0, Lcom/android/internal/os/UidAppSensorPowerCalculator;->mSensors:Ljava/util/List;
    ...
    iget-wide v5, v0, Lcom/android/internal/os/UidAppSensorPowerCalculator;->mGpsPowerOn:D
