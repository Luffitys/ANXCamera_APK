...
.field public static final KEY_960_WATERMARK_STATUS:Ljava/lang/String; = "pref_960_watermark_status"
...
.field public static final KEY_DUAL_VIDEO:Ljava/lang/String; = "pref_dual_video_key"
...
.field private static sEdgePhotoEnable:Z = false

.field private static sGoolgeLensAvilability:Z = false
...
.method static constructor <clinit>()V
    ...
    const-string v2, "pref_camera_groupshot_mode_key"
...
.method public static addLensDirtyDetectedTimes()V
    ...
    const-string v2, "pref_lens_dirty_detect_enabled_key"
...
.method public static checkLensAvailability(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->lc()Z
...
.method public static getCustomWaterMarkState(IZ)Z
    ...
    invoke-virtual {p0}, Lcom/mi/config/a;->je()Z
...
.method public static getDefaultFNumber()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/mi/config/a;->r(Z)Ljava/lang/String;
...
.method public static getDefaultPreferenceId(I)I
    ...
    :cond_3
    sget-boolean v0, Lcom/mi/config/b;->Mm:Z

    if-nez v0, :cond_5

    sget-boolean v0, Lcom/mi/config/b;->Nm:Z
...
.method public static final getDualCameraWaterMarkFilePathVendor()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/camera/CameraSettings;->getDualCameraWaterMarkFilePathVendor(Z)Ljava/lang/String;
...
.method public static final getDualCameraWaterMarkFilePathVendor(Z)Ljava/lang/String;
    ...
    const-string p0, "/vendor/etc/camera/dualcamera_india.png"
    ...
    :cond_2
    const-string p0, "/vendor/etc/camera/dualcamera.png"
...
.method public static getDualCameraWaterMarkState(IZ)Z
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->je()Z
...
.method public static getGoogleLensSuggestionsSettingNeedRemove(IZ)Z
    ...
    :cond_0
    invoke-static {}, Lcom/mi/config/b;->re()Z
...
.method public static getMovieSolidSettingNeedRemove(IZ)Z
    .locals 2
...
.method public static getNormalWideLDCNeedRemove(IZ)Z
    .locals 0
...
.method public static getScreenLightBrightness()I
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Ud()I
...
.method public static getShaderEffect()I
    ...
    const-string v3, "getShaderEffect: mode = "
...
.method public static getVideoTagSettingNeedRemove(IZ)Z
    .locals 2
    ...
    invoke-virtual {v1}, Lcom/android/camera/module/loader/camera2/Camera2OpenManager;->getPendingCameraId()I
...
.method public static getVolumeCameraSettingNeedRemove(IZ)Z
    ...
    :cond_0
    sget-boolean p0, Lcom/mi/config/b;->pn:Z
...
.method public static is960WatermarkOn(I)Z
    .locals 3
    ...
    const-string v2, "pref_960_watermark_status"
...
.method public static isAutoZoomEnabled(I)Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/runing/ComponentRunningAutoZoom;->isEnabled(I)Z
...
.method public static isCameraParallelProcessEnable()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->be()Z
...
.method public static isCinematicAspectRatioEnabled(I)Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/data/data/config/DataItemConfig;->getCinematicAspectRatio()Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;->isEnabled(I)Z
...
.method public static isDocumentModeOn(I)Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/runing/ComponentRunningDocument;->isEnabled(I)Z
...
.method public static isDualCameraWaterMarkOpen()Z
    ...
    invoke-static {v1}, Lcom/mi/config/b;->F(Z)Z
...
.method public static isFPS960(I)Z
    .locals 1
...
.method public static isFaceBeautyOn(ILcom/android/camera/fragment/beauty/BeautyValues;)Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/runing/ComponentRunningShine;->isSmoothBarVideoBeautyVersion(I)Z
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/data/data/runing/ComponentRunningShine;->isVideoBeautyOpen(I)Z
...
.method public static isFrontCameraWaterMarkOpen()Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->je()Z
...
.method public static isGradienterOn()Z
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera/data/data/config/ComponentConfigGradienter;->getComponentValue(I)Ljava/lang/String;
...
.method public static isH265EncoderSupport()Z
    .locals 5
...
.method public static isLiveShotOn()Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/data/data/runing/ComponentRunningLiveShot;->isLiveShotOn()Z
...
.method public static isMacroModeEnabled(II)Z
    .locals 2
    ...
    invoke-virtual {v0, p0, p1}, Lcom/android/camera/data/data/config/ComponentRunningMacroMode;->isSwitchOn(II)Z
...
.method public static isMiLiveBeautyOpen()Z
    .locals 3
...
.method public static isSubtitleEnabled(I)Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/runing/ComponentRunningSubtitle;->isEnabled(I)Z
...
.method public static isSupport960VideoEditor()Z
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->isSupport960VideoEditor()Z
...
.method public static isSupportBeautyMakeup()Z
    ...
    const-string v2, "isSupportBeautyMakeup: "
...
.method public static isSupportedZslShutter()Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Re()Z
...
.method public static isVideoCaptureVisible()Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Ce()Z
    ...
    invoke-virtual {v3, v0}, Lcom/android/camera/data/data/runing/ComponentRunningShine;->isVideoBeautyOpen(I)Z
...
.method public static isVideoQuality8KOpen(I)Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/data/data/runing/DataItemRunning;->getComponentRunning8KVideoQuality()Lcom/android/camera/data/data/config/ComponentRunning8KVideoQuality;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/config/ComponentRunning8KVideoQuality;->isEnabled(I)Z
...
.method public static setCinematicAspectRatioEnabled(IZ)V
    ...
    invoke-virtual {v0, p0, p1}, Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;->setEnabled(IZ)V
...
.method public static setDocumentModeOn(IZ)V
    .locals 1
    ...
    invoke-virtual {v0, p0, p1}, Lcom/android/camera/data/data/runing/ComponentRunningDocument;->setEnabled(IZ)V
...
.method public static setLiveShotOn(Z)V
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/runing/ComponentRunningLiveShot;->setLiveShotOn(Z)V
...
.method public static setShaderEffect(I)V
    ...
    invoke-virtual {v1, v3, p0}, Lcom/android/camera/data/data/runing/ComponentRunningShine;->setVideoBeautySwitch(IZ)V
...
.method public static setVideoQuality8K(IZ)V
    .locals 1
    ...
    invoke-virtual {v0, p0, p1}, Lcom/android/camera/data/data/config/ComponentRunning8KVideoQuality;->setEnabled(IZ)V
