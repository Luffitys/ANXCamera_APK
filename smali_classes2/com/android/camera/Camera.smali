...
.method static synthetic access$500(Lcom/android/camera/Camera;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$802(Lcom/android/camera/Camera;Z)Z
    .locals 0
...
.method private releaseAll(ZZZ)V
    ...
    invoke-direct {v0, p0, p2, p3}, Lcom/android/camera/a;-><init>(Lcom/android/camera/Camera;ZZ)V
...
.method private resumeCamera()V
    ...
    iget-boolean v2, p0, Lcom/android/camera/ActivityBase;->mJumpedToGallery:Z
    ...
    iput-boolean v12, p0, Lcom/android/camera/ActivityBase;->mJumpedToGallery:Z
    ...
    invoke-interface {v0, v11}, Lcom/android/camera/module/Module;->enableCameraControls(Z)V

    iput-boolean v12, p0, Lcom/android/camera/ActivityBase;->mReleaseByModule:Z
    ...
    invoke-interface {v5}, Lcom/android/camera/module/Module;->isSelectingCapturedResult()Z
    ...
    invoke-virtual {v2, v8}, Lcom/android/camera/fragment/BaseFragmentDelegate;->delegateEvent(I)V
    ...
    const-class v3, Lcom/android/camera/data/observeable/VMProcessing;
...
.method public synthetic b(ZZ)V
    ...
    const-string p1, "Camera2OpenManager release ignored."
...
.method public handleScreenSlideKeyEvent(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->rc()Z
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/module/BaseModule;->updateScreenSlide(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/camera/statistic/CameraStatUtil;->track(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget-boolean v2, v0, Lcom/android/camera/ActivityBase;->mActivityPaused:Z
    ...
    :cond_1
    iget-wide v11, v0, Lcom/android/camera/Camera;->mLastKeyDownEventTime:J
    ...
    iget-wide v4, v0, Lcom/android/camera/Camera;->mLastKeyDownEventTime:J
    ...
    iput-wide v13, v0, Lcom/android/camera/Camera;->mLastKeyDownEventTime:J
    ...
    iget-wide v4, v0, Lcom/android/camera/Camera;->mLastKeyUpEventTime:J

    const-wide/16 v19, 0x96

    move-wide/from16 v17, v4

    invoke-static/range {v15 .. v20}, Lcom/android/camera/Util;->isTimeout(JJJ)Z

    move-result v4

    if-eqz v4, :cond_3

    iput v3, v0, Lcom/android/camera/Camera;->mLastIgnoreKey:I
    ...
    iget v4, v0, Lcom/android/camera/Camera;->mLastIgnoreKey:I
    ...
    iput-boolean v3, v0, Lcom/android/camera/Camera;->mIsScreenSlideOff:Z
    ...
    iput-boolean v10, v0, Lcom/android/camera/Camera;->mIsScreenSlideOff:Z
    ...
    invoke-interface {v11}, Lcom/android/camera/module/Module;->isFrameAvailable()Z
    ...
    invoke-static {v2}, Lcom/android/camera/HybridZoomingSystem;->setZoomingSourceIdentity(I)V
    ...
    invoke-interface {v2, v1, v11}, Lcom/android/camera/module/Module;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public onModeSelected(Lcom/android/camera/module/loader/StartControl;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/BaseFragmentDelegate;->initTargetFragment(I)V
...
.method public onPause()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/ActivityBase;->controlScreenNailDraw(Z)V
...
.method public showNewBie(I)Z
    ...
    invoke-interface {p0, p1, v4}, Lcom/android/camera/data/provider/DataProvider$ProviderEditor;->putBoolean(Ljava/lang/String;Z)Lcom/android/camera/data/provider/DataProvider$ProviderEditor;
