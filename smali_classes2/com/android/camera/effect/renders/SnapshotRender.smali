...
.field private mUltraPixelCameraWaterMarkBitmap:Landroid/graphics/Bitmap;
...
.method static synthetic access$1500(Lcom/android/camera/effect/renders/SnapshotRender;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$1502(Lcom/android/camera/effect/renders/SnapshotRender;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$1700(Lcom/android/camera/effect/renders/SnapshotRender;)Landroid/graphics/Bitmap;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/effect/renders/SnapshotRender;->mUltraPixelCameraWaterMarkBitmap:Landroid/graphics/Bitmap;

    return-object p0
.end method

.method static synthetic access$1702(Lcom/android/camera/effect/renders/SnapshotRender;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 0

    iput-object p1, p0, Lcom/android/camera/effect/renders/SnapshotRender;->mUltraPixelCameraWaterMarkBitmap:Landroid/graphics/Bitmap;

    return-object p1
.end method

.method static synthetic access$1800(Lcom/android/camera/effect/renders/SnapshotRender;Landroid/content/Context;)Landroid/graphics/Bitmap;
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/effect/renders/SnapshotRender;->loadUltraWatermark(Landroid/content/Context;)Landroid/graphics/Bitmap;
...
.method static synthetic access$1900(Lcom/android/camera/effect/renders/SnapshotRender;)Lcom/android/camera/effect/framework/utils/CounterUtil;
    .locals 0
...
.method static synthetic access$2000(Lcom/android/camera/effect/renders/SnapshotRender;)Lcom/android/camera/effect/framework/image/MemYuvImage;
    .locals 0
...
.method static synthetic access$2100(Lcom/android/camera/effect/renders/SnapshotRender;)Lcom/android/camera/effect/framework/graphics/Splitter;
    .locals 0
...
.method static synthetic access$2200(Lcom/android/camera/effect/renders/SnapshotRender;)Lcom/android/camera/effect/framework/utils/CounterUtil;
    .locals 0
...
.method static synthetic access$2300(Lcom/android/camera/effect/renders/SnapshotRender;)I
    .locals 0
...
.method static synthetic access$2400(Lcom/android/camera/effect/renders/SnapshotRender;)V
    .locals 0
...
.method private destroy()V
    ...
    :cond_3
    iget-object v0, p0, Lcom/android/camera/effect/renders/SnapshotRender;->mUltraPixelCameraWaterMarkBitmap:Landroid/graphics/Bitmap;
    ...
    iput-object v1, p0, Lcom/android/camera/effect/renders/SnapshotRender;->mUltraPixelCameraWaterMarkBitmap:Landroid/graphics/Bitmap;
...
.method private loadCameraWatermark(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    :try_start_2
    invoke-static {p1, v1}, Lcom/android/camera/effect/renders/SnapshotRender;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    ...
    :try_start_4
    invoke-static {p0, v1}, Lcom/android/camera/effect/renders/SnapshotRender;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method private loadUltraWatermark(Landroid/content/Context;)Landroid/graphics/Bitmap;
    .locals 3
    ...
    sget-object v2, Lcom/android/camera/Util;->WATERMARK_ULTRA_PIXEL_FILE_NAME:Ljava/lang/String;
    ...
    :try_start_4
    invoke-static {p0, p1}, Lcom/android/camera/effect/renders/SnapshotRender;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
