...
.method public clearAudio()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/module/impl/component/ILive$ILiveRecorder;->setAudioPath(Ljava/lang/String;)V

    const/4 p0, 0x0

    invoke-static {p0, p0}, Lcom/android/camera/CameraSettings;->setCurrentLiveMusic(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getTotalRecordingTime()J
    ...
    invoke-static {p0}, Lcom/android/camera/module/impl/component/ILive;->getTotolDuration(Ljava/util/List;)J
...
.method public initPreview(IIILcom/android/camera/CameraScreenNail;)V
    ...
    invoke-virtual {p3, v0, v1}, Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;->setMaxDuration(J)Lcom/android/camera/module/impl/component/MiLiveRecorder$Builder;
    ...
    sget-object p4, Lcom/android/camera/module/impl/component/FileUtils;->VIDEO_TMP:Ljava/lang/String;
...
.method public initResource()V
    ...
    const-string v1, "music_global.zip"

    goto :goto_0

    :cond_2
    const-string v1, "music_cn.zip"
...
.method public onStateChange(I)V
    ...
    iget p1, p0, Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;->mRecordState:I
    ...
    new-instance v0, Lcom/android/camera/module/impl/component/x;

    invoke-direct {v0, p0}, Lcom/android/camera/module/impl/component/x;-><init>(Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/module/impl/component/w;-><init>(Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;)V
    ...
    new-instance v0, Lcom/android/camera/module/impl/component/v;

    invoke-direct {v0, p0}, Lcom/android/camera/module/impl/component/v;-><init>(Lcom/android/camera/module/impl/component/MiLiveConfigChangesImpl;)V
...
.method public onSurfaceTextureUpdated(Lcom/android/camera/effect/draw_mode/DrawExtTexAttribute;)V
    ...
    invoke-interface {p0, p1}, Lcom/android/camera/SurfaceTextureScreenNail$SurfaceTextureScreenNailCallback;->onSurfaceTextureUpdated(Lcom/android/camera/effect/draw_mode/DrawExtTexAttribute;)V
...
.method public release()V
    ...
    invoke-interface {v2}, Lcom/android/camera/module/impl/component/ILive$ILiveRecorder;->getLiveSegments()Ljava/util/List;
