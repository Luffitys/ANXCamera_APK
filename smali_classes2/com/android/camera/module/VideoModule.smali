...
.method private getRecorderMaxFileSize(I)J
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->ub()Z
...
.method private initAutoZoom()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Cb()Z
...
.method private initializeRecorder(Z)Z
    ...
    invoke-virtual {p0, v2, v4, v5, p1}, Lcom/android/camera/module/VideoBase;->genContentValues(IILjava/lang/String;Z)Landroid/content/ContentValues;
...
.method private onStartRecorderSucceed()V
    ...
    invoke-static {}, Lcom/android/camera/HybridZoomingSystem;->getMinimumStandaloneOpticalZoomRatio()F

    move-result v0

    invoke-virtual {p0, v0}, Lcom/android/camera/module/BaseModule;->setMinZoomRatio(F)V

    invoke-static {}, Lcom/android/camera/HybridZoomingSystem;->getMaximumStandaloneOpticalZoomRatio()F
    ...
    iput-wide v2, p0, Lcom/android/camera/module/VideoBase;->mRecordingStartTime:J
...
.method private postProcessVideo(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->Eb()Z
    ...
    invoke-virtual {v9}, Lcom/mi/config/a;->Eb()Z
...
.method private setupRecorder(Landroid/media/MediaRecorder;)V
    ...
    invoke-virtual {v5}, Lcom/mi/config/a;->ub()Z
...
.method private startRecorder()Z
    ...
    invoke-static {}, Lcom/android/camera/ThermalHelper;->notifyThermal4KRecordStart()V
...
.method private stopRecorder()V
    ...
    invoke-static {}, Lcom/android/camera/ThermalHelper;->notifyThermal4KRecordStop()V
...
.method private updateFrontMirror()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->vc()Z
...
.method private updateHFRDeflicker()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Eb()Z
...
.method public varargs consumePreference([I)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->Sa()Z
...
.method protected getOperatingMode()I
    ...
    invoke-virtual {p0, v4}, Lcom/android/camera/module/VideoBase;->isFaceBeautyOn(Lcom/android/camera/fragment/beauty/BeautyValues;)Z
...
.method public onInfo(Landroid/media/MediaRecorder;II)V
    ...
    iget p1, p0, Lcom/android/camera/module/VideoBase;->mOutputFormat:I

    iget p2, p0, Lcom/android/camera/module/VideoModule;->mCurrentFileNumber:I

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/module/VideoBase;->genContentValues(II)Landroid/content/ContentValues;
...
.method public onPauseButtonClick()V
    ...
    invoke-static {p0}, Lcom/android/camera/statistic/CameraStatUtil;->trackPauseVideoRecording(Z)V
...
.method public onZoomingActionStart(I)V
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->mb()Z
...
.method public reShowMoon()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Ta()Z
...
.method protected readVideoPreferences()V
    ...
    invoke-virtual {v1, v4, v6}, Lcom/android/camera/ui/RotateTextToast;->show(II)V
...
.method public setAutoZoomStartCapture(Landroid/graphics/RectF;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera2/Camera2Proxy;->setAutoZoomStartCapture([F)V
...
.method public setAutoZoomStopCapture(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera2/Camera2Proxy;->setAutoZoomStopCapture(I)V
...
.method public startTracking(Landroid/graphics/RectF;)V
    ...
    invoke-static {p0}, Lcom/android/camera/statistic/CameraStatUtil;->trackSelectObject(Z)V
...
.method public stopVideoRecording(ZZ)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->mb()Z
    ...
    iget-object v12, v0, Lcom/android/camera/module/VideoModule;->mSpeed:Ljava/lang/String;

    iget v13, v0, Lcom/android/camera/module/VideoModule;->mQuality:I
    ...
    iget v15, v0, Lcom/android/camera/module/VideoModule;->mFrameRate:I

    iget v3, v0, Lcom/android/camera/module/VideoModule;->mTimeBetweenTimeLapseFrameCaptureMs:I

    iget-object v9, v0, Lcom/android/camera/module/VideoBase;->mBeautyValues:Lcom/android/camera/fragment/beauty/BeautyValues;
    ...
    invoke-static/range {v7 .. v19}, Lcom/android/camera/statistic/CameraStatUtil;->trackVideoRecorded(ZIZZZLjava/lang/String;IIIILcom/android/camera/fragment/beauty/BeautyValues;J)V
...
.method public takeVideoSnapShoot()Z
    ...
    invoke-static {p0}, Lcom/android/camera/statistic/CameraStatUtil;->trackVideoSnapshot(Z)V
...
.method protected updateRecordingTime()V
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->Sa()Z
