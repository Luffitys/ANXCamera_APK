...
.method private filterByConfig()V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/camera/BasePreferenceActivity;->removeFromGroup(Landroid/preference/Preference;Ljava/lang/String;)V

    iget-object v2, p0, Lcom/android/camera/CameraPreferenceActivity;->mPreferenceGroup:Landroid/preference/PreferenceScreen;

    const-string v4, "pref_camera_movie_solid_key"

    invoke-virtual {p0, v2, v4}, Lcom/android/camera/BasePreferenceActivity;->removeFromGroup(Landroid/preference/Preference;Ljava/lang/String;)V
    ...
    const-string v5, "pref_fingerprint_capture_key"

    invoke-virtual {p0, v2, v5}, Lcom/android/camera/BasePreferenceActivity;->removeFromGroup(Landroid/preference/Preference;Ljava/lang/String;)V
    ...
    const-string v6, "filterByConfig: isSupportVideoFrontMirror = "
    ...
    invoke-virtual {p0, v1, v5}, Lcom/android/camera/BasePreferenceActivity;->removeFromGroup(Landroid/preference/Preference;Ljava/lang/String;)V

    goto :goto_0

    :cond_2
    invoke-virtual {p0, v0, v5}, Lcom/android/camera/BasePreferenceActivity;->removeFromGroup(Landroid/preference/Preference;Ljava/lang/String;)V
...
.method private filterByDeviceID()V
    ...
    invoke-virtual {p0, v0, v7}, Lcom/android/camera/BasePreferenceActivity;->removePreference(Landroid/preference/PreferenceGroup;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->Db()Z
    ...
    const-string v5, "pref_priority_storage"
    ...
    const-string v5, "pref_auto_chroma_flash_key"
    ...
    :cond_b
    invoke-static {}, Lcom/mi/config/b;->rj()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->Zb()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->Rc()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->Pb()Z
...
.method private filterByFrom()V
    ...
    const-string v2, "pref_video_autoexposure_key"
    ...
    const-string v4, "pref_live_volumekey_function_key"

    const-string v5, "pref_video_volumekey_function_key"
    ...
    const-string v1, "pref_6mw_status"
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->xb()Z
...
.method private updateEntries()V
    ...
    invoke-virtual {v2, v5}, Lcom/android/camera/ui/PreviewListPreference;->setDefaultValue(Ljava/lang/Object;)V

    invoke-virtual {v2, v5}, Lcom/android/camera/ui/PreviewListPreference;->setValue(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v7}, Lcom/android/camera/ui/PreviewListPreference;->setValue(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v2}, Landroid/preference/ListPreference;->setDefaultValue(Ljava/lang/Object;)V
    ...
    invoke-static {p0}, Lcom/mi/config/b;->v(Z)Z
...
.method private updateWaterMark(Landroid/content/SharedPreferences;Lcom/android/camera/ui/ValuePreference;)V
    ...
    invoke-static {v0}, Lcom/mi/config/b;->v(Z)Z
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v0}, Lcom/android/camera/statistic/CameraStatUtil;->trackPreferenceChange(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public updateConflictPreference(Landroid/preference/Preference;)V
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/camera/BasePreferenceActivity;->removePreference(Landroid/preference/PreferenceGroup;Ljava/lang/String;)Z
