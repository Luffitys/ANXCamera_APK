...
.field private mCinematicAspectRatio:Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;
...
.method public constructor <init>(II)V
    ...
    new-instance p2, Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;

    invoke-direct {p2, p0}, Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;-><init>(Lcom/android/camera/data/data/config/DataItemConfig;)V

    iput-object p2, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mCinematicAspectRatio:Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;
...
# virtual methods
.method public getCinematicAspectRatio()Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mCinematicAspectRatio:Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;
...
.method public reConfigCinematicAspectRatioIfRatioChanged(ILjava/lang/String;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/data/data/config/DataItemConfig;->getCinematicAspectRatio()Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;->isEnabled(I)Z
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;->setEnabled(IZ)V
...
.method public reConfigHhrIfFlashChanged(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, p1, v3}, Lcom/android/camera/data/data/config/ComponentConfigHdr;->setComponentValue(ILjava/lang/String;)V
...
.method public reInitComponent(IILcom/android/camera2/CameraCapabilities;)V
    ...
    iget-object v0, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mCinematicAspectRatio:Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;

    invoke-virtual {v0, p1, p2, p3}, Lcom/android/camera/data/data/config/ComponentConfigCinematicAspectRatio;->reInit(IILcom/android/camera2/CameraCapabilities;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/camera/data/data/config/ComponentConfigSlowMotion;->reInit(I)V
    ...
    iget-object v1, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mSlowMotion:Lcom/android/camera/data/data/config/ComponentConfigSlowMotion;

    invoke-virtual {v0, p1, p2, p3, v1}, Lcom/android/camera/data/data/config/ComponentConfigSlowMotionQuality;->reInit(IILcom/android/camera2/CameraCapabilities;Lcom/android/camera/data/data/config/ComponentConfigSlowMotion;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/data/data/config/ComponentConfigGradienter;->reInit(II)V
