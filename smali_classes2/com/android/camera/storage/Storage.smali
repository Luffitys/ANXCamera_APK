...
.method public static addDNGToDataBase(Landroid/content/Context;Ljava/lang/String;III)Landroid/net/Uri;
    .locals 5
...
.method public static addImage(Landroid/content/Context;Ljava/lang/String;JLandroid/location/Location;I[BIIZZZZZLjava/lang/String;Lcom/xiaomi/camera/core/PictureInfo;)Landroid/net/Uri;
    ...
    invoke-static {v1, v2, v3}, Lcom/android/camera/storage/Storage;->generateFilepath4Jpeg(Ljava/lang/String;ZZ)Ljava/lang/String;
    ...
    :try_start_2
    invoke-static {v6, v10}, Lcom/android/camera/FileCompat;->getFileOutputStream(Ljava/lang/String;Z)Ljava/io/OutputStream;
    ...
    :goto_4
    :try_start_7
    invoke-static {v1, v0, v12}, Lcom/android/camera/storage/Storage;->flipJpeg([BZZ)Landroid/graphics/Bitmap;

    move-result-object v0

    if-eqz v0, :cond_4

    invoke-virtual {v2, v0}, Lcom/android/gallery3d/exif/ExifInterface;->setCompressedThumbnail(Landroid/graphics/Bitmap;)Z
    ...
    :cond_5
    invoke-virtual {v2, v8, v11}, Lcom/android/gallery3d/exif/ExifInterface;->writeExif(Landroid/graphics/Bitmap;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v11, v0, v2, v1}, Ljava/io/BufferedOutputStream;->write([BII)V
    ...
    invoke-virtual {v11, v0, v8, v1}, Ljava/io/BufferedOutputStream;->write([BII)V
    :try_end_7
    ...
    invoke-static {v6, v13, v14, v4, v5}, Lcom/android/camera/ExifHelper;->writeExifByFilePath(Ljava/lang/String;ILandroid/location/Location;J)V
    :try_end_8
    ...
    invoke-static {v0, v13, v14, v4, v5}, Lcom/android/camera/ExifHelper;->writeExifByFd(Ljava/io/FileDescriptor;ILandroid/location/Location;J)V
    :try_end_a
    ...
    :try_start_b
    invoke-static {v1, v2}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_b
    ...
    const-string v12, "write exif failed, file is "
    ...
    :cond_c
    :try_start_11
    invoke-static {v1, v9}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_11
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/camera/Util;->isProduceFocusInfoSuccess([B)Z
    ...
    invoke-static {v10, v11, v12}, Lcom/android/camera/Util;->getCenterFocusDepthIndex([BII)I
    ...
    invoke-static {v7, v11, v11}, Lcom/android/camera/storage/Storage;->generateFilepath4Jpeg(Ljava/lang/String;ZZ)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v11}, Lcom/android/camera/storage/Storage;->generateFilepath4Jpeg(Ljava/lang/String;ZZ)Ljava/lang/String;
    ...
    invoke-static {v7}, Lcom/android/camera/storage/Storage;->deleteImage(Ljava/lang/String;)V
...
.method public static addRawImage(Landroid/content/Context;Ljava/lang/String;Landroid/hardware/camera2/CameraCharacteristics;Landroid/hardware/camera2/CaptureResult;[BIII)Landroid/net/Uri;
    .locals 18
    ...
    :try_start_0
    new-instance v12, Landroid/hardware/camera2/DngCreator;

    move-object/from16 v6, p2

    move-object/from16 v7, p3

    invoke-direct {v12, v6, v7}, Landroid/hardware/camera2/DngCreator;-><init>(Landroid/hardware/camera2/CameraCharacteristics;Landroid/hardware/camera2/CaptureResult;)V
    :try_end_0
    ...
    invoke-static {v3, v14}, Lcom/android/camera/FileCompat;->getFileOutputStream(Ljava/lang/String;Z)Ljava/io/OutputStream;
    ...
    :try_start_4
    invoke-static/range {p7 .. p7}, Lcom/android/camera/ExifHelper;->getExifOrientation(I)Ljava/lang/String;
    ...
    invoke-virtual {v12, v6}, Landroid/hardware/camera2/DngCreator;->setOrientation(I)Landroid/hardware/camera2/DngCreator;
    ...
    :try_start_5
    invoke-virtual/range {v6 .. v11}, Landroid/hardware/camera2/DngCreator;->writeInputStream(Ljava/io/OutputStream;Landroid/util/Size;Ljava/io/InputStream;J)V

    move/from16 v6, p7

    invoke-static {v0, v3, v1, v2, v6}, Lcom/android/camera/storage/Storage;->addDNGToDataBase(Landroid/content/Context;Ljava/lang/String;III)Landroid/net/Uri;
    ...
    const-string v7, "addRawImage path "
    ...
    :goto_1
    invoke-static {v0, v3, v6, v7, v2}, Lcom/android/camera/storage/Storage;->saveToCloudAlbum(Landroid/content/Context;Ljava/lang/String;JZ)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    :try_start_6
    invoke-static {v5, v14}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_6
    ...
    :try_start_7
    invoke-static {v5, v15}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_5

    :cond_2
    :try_start_8
    invoke-static {v5, v13}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_8
    .catchall {:try_start_8 .. :try_end_8} :catchall_7

    :try_start_9
    invoke-static {v5, v12}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_9
    ...
    :try_start_d
    invoke-static {v1, v15}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public static generateFilepath4Jpeg(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method public static generateFilepath4Jpeg(Ljava/lang/String;ZZ)Ljava/lang/String;
    .locals 1
...
.method public static hasSecondaryStorage()Z
    ...
    invoke-static {}, Lcom/mi/config/b;->sj()Z
...
.method private static insertToMediaStore(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;Z)Landroid/net/Uri;
    ...
    sget-object p5, Landroid/provider/MediaStore$Images$Media;->EXTERNAL_CONTENT_URI:Landroid/net/Uri;
    ...
    const-string p8, "external"

    invoke-static {p8}, Landroid/provider/MediaStore$Files;->getContentUri(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p8

    invoke-virtual {p5, p8, v0}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
...
.method public static newImage(Landroid/content/Context;Ljava/lang/String;JIII)Landroid/net/Uri;
    ...
    invoke-static {p1}, Lcom/android/camera/storage/Storage;->generateFilepath4Jpeg(Ljava/lang/String;)Ljava/lang/String;
...
.method public static updateImage(Landroid/content/Context;[BLcom/android/gallery3d/exif/ExifInterface;Landroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;)Z
    ...
    :goto_0
    invoke-static/range {p4 .. p4}, Lcom/android/camera/storage/Storage;->generateFilepath4Jpeg(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {p9 .. p9}, Lcom/android/camera/storage/Storage;->generateFilepath4Jpeg(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v4}, Lcom/android/camera/FileCompat;->getFileOutputStream(Ljava/lang/String;Z)Ljava/io/OutputStream;
    ...
    :catch_0
    :try_start_3
    sget-object v13, Lcom/android/camera/storage/Storage;->TAG:Ljava/lang/String;

    const-string v14, "Failed to rewrite Exif"
    ...
    :goto_4
    invoke-virtual {v11, v13}, Ljava/io/BufferedInputStream;->read([B)I
    ...
    invoke-virtual {v12, v13, v5, v14}, Ljava/io/OutputStream;->write([BII)V
    :try_end_3
    ...
    const-string v4, "Exception when delete old file "
    ...
    invoke-static {v13, v4, v0}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-virtual {v0, v9, v3}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Double;)V
    ...
    invoke-static {v7, v0}, Lcom/android/camera/storage/Storage;->renameSdcardFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v8, v7}, Lcom/android/camera/storage/Storage;->renameSdcardFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v8}, Lcom/android/camera/storage/Storage;->deleteSdcardFile(Ljava/lang/String;)Z
    ...
    invoke-static {v7}, Lcom/android/camera/FileCompat;->removeDocumentFileForPath(Ljava/lang/String;)V
    ...
    invoke-static {v2, v7, v0, v1, v5}, Lcom/android/camera/storage/Storage;->saveToCloudAlbum(Landroid/content/Context;Ljava/lang/String;JZ)V
