...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ItfGvOnItemClickListener;,
...
.method static synthetic access$100(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->onGvItemClick(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;II)V
...
.method static synthetic access$300(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;)Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ItfGvOnItemClickListener;
    .locals 0
...
.method private declared-synchronized showColor(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;Lcom/android/camera/fragment/mimoji/MimojiLevelBean;I)V
    ...
    invoke-virtual {v2, v6, v3}, Landroid/support/v7/widget/LinearLayoutManager;->scrollToPositionWithOffset(II)V
...
.method public notifyThumbnailUpdate(III)V
    ...
    invoke-virtual {p0, p3, p1}, Lcom/android/camera/ui/baseview/BaseRecyclerAdapter;->updateData(ILjava/lang/Object;)V
...
.method public onBindViewHolder(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;I)V
    ...
    invoke-virtual {v4, v5, v6}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->setChangeDuration(J)V

    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView;->getItemAnimator()Landroid/support/v7/widget/RecyclerView$ItemAnimator;

    move-result-object v4

    invoke-virtual {v4, v5, v6}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->setRemoveDuration(J)V

    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView;->getItemAnimator()Landroid/support/v7/widget/RecyclerView$ItemAnimator;

    move-result-object v4

    invoke-virtual {v4, v5, v6}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->setMoveDuration(J)V
    ...
    new-instance v4, Lcom/android/camera/ui/baseview/BaseNoScrollGridLayoutManager;

    iget-object v6, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mContext:Landroid/content/Context;

    invoke-direct {v4, v6, v5}, Lcom/android/camera/ui/baseview/BaseNoScrollGridLayoutManager;-><init>(Landroid/content/Context;I)V
    ...
    iget-object p1, p1, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;->mColorRecycleView:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-direct {p1, p0, v2, p2}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$1;-><init>(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;I)V

    invoke-virtual {v2, p1}, Lcom/android/camera/ui/baseview/BaseRecyclerAdapter;->setOnRecyclerItemClickListener(Lcom/android/camera/ui/baseview/OnRecyclerItemClickListener;)V
...
.method public declared-synchronized refreshData(Ljava/util/List;ZZ)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/ui/baseview/BaseRecyclerAdapter;->getItemCount()I
    ...
    invoke-virtual {p3, v0}, Lcom/android/camera/ui/baseview/BaseRecyclerAdapter;->setDataList(Ljava/util/ArrayList;)V
