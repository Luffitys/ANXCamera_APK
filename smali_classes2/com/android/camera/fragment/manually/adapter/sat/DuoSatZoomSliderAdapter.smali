...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->RANGE_1X_TO_2X_ENTRY_INDEX_X:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->RANGE_1X_TO_2X_ZOOM_RATIO_Y:[F
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/camera/data/data/ComponentData;ILcom/android/camera/fragment/manually/ZoomValueListener;)V
    .locals 9
    ...
    sget-object p2, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->RANGE_1X_TO_2X_ENTRY_INDEX_X:[F

    sget-object p3, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->RANGE_1X_TO_2X_ZOOM_RATIO_Y:[F

    invoke-static {p2, p3}, Landroid/util/Spline;->createLinearSpline([F[F)Landroid/util/Spline;

    move-result-object p2

    iput-object p2, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mRange1XTo2XEntryToZoomRatioSpline:Landroid/util/Spline;

    sget-object p2, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->RANGE_1X_TO_2X_ZOOM_RATIO_Y:[F

    sget-object p3, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->RANGE_1X_TO_2X_ENTRY_INDEX_X:[F

    invoke-static {p2, p3}, Landroid/util/Spline;->createLinearSpline([F[F)Landroid/util/Spline;

    move-result-object p2

    iput-object p2, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mRange1XTo2XZoomRatioToEntrySpline:Landroid/util/Spline;
    ...
    iget-object p2, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mEntryLayouts:[Landroid/text/StaticLayout;
    ...
    iget v1, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mZoomRatioWide:F
...
.method private convertSplineYToZoomRatioY([F)[F
    ...
    iget v5, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mZoomRatioMax:F
...
.method private drawText(ILandroid/graphics/Canvas;)V
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mEntryLayouts:[Landroid/text/StaticLayout;
...
.method private getDisplayedZoomRatio(F)Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mXTextStyle:Landroid/text/style/TextAppearanceSpan;

    const-string p1, "X"

    invoke-static {v0, p1, p0, v2}, Lcom/android/camera/Util;->appendInApi26(Landroid/text/SpannableStringBuilder;Ljava/lang/CharSequence;Ljava/lang/Object;I)Landroid/text/SpannableStringBuilder;
...
.method public draw(ILandroid/graphics/Canvas;Z)V
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mPaint:Landroid/graphics/Paint;
...
.method public isEnable()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mEnable:Z
...
.method public mapPositionToZoomRatio(F)F
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mRange1XTo2XEntryToZoomRatioSpline:Landroid/util/Spline;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mEntryToZoomRatioSpline:Landroid/util/Spline;
...
.method public mapZoomRatioToPosition(F)F
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mRange1XTo2XZoomRatioToEntrySpline:Landroid/util/Spline;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mZoomRatioToEntrySpline:Landroid/util/Spline;
...
.method public measureGap(I)F
    ...
    :cond_0
    iget p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mLineLineGap:I
    ...
    :cond_1
    :goto_1
    iget p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mLineTextGap:I
...
.method public measureWidth(I)F
    ...
    :cond_0
    iget p0, p0, Lcom/android/camera/fragment/manually/adapter/sat/DuoSatZoomSliderAdapter;->mLineWidth:I
...
.method public onPositionSelect(Landroid/view/View;IF)V
    ...
    invoke-static {p1, p2}, Lcom/android/camera/HybridZoomingSystem;->add(FF)F
