...
# instance fields
.field private mAcquiredImageCountMap:Ljava/util/Map;
...
.field private mPooledImageCountMap:Ljava/util/Map;
...
.method public queueImage(Landroid/media/Image;)V
    ...
    sget-object v3, Lcom/xiaomi/camera/imagecodec/ImagePool;->TAG:Ljava/lang/String;
    ...
    :try_start_3
    invoke-direct {p0, v0, v1}, Lcom/xiaomi/camera/imagecodec/ImagePool;->changePooledImageCountLocked(Lcom/xiaomi/camera/imagecodec/ImagePool$ImageFormat;I)I
    ...
    const-string v2, "Image has exist: "
