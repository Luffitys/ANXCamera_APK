...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;

    iput-boolean v0, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mIsActionItemsStale:Z

    invoke-direct {p0, v0}, Lcom/miui/internal/view/menu/MenuBuilder;->setShortcutsVisibleInner(Z)V
...
.method private addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-static {v1, v8}, Lcom/miui/internal/view/menu/MenuBuilder;->findInsertIndex(Ljava/util/ArrayList;I)I
...
.method private dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-interface {v3, v5}, Lcom/miui/internal/view/menu/MenuPresenter;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public addIntentOptions(IIILandroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I[Landroid/view/MenuItem;)I
    ...
    iget-object v2, v0, Lcom/miui/internal/view/menu/MenuBuilder;->mContext:Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/miui/internal/view/menu/MenuBuilder;->removeGroup(I)V
    ...
    invoke-virtual {p0, v11, v12, v13, v10}, Lcom/miui/internal/view/menu/MenuBuilder;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method public collapseItemActionView(Lcom/miui/internal/view/menu/MenuItemImpl;)Z
    ...
    iput-object v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mExpandedItem:Lcom/miui/internal/view/menu/MenuItemImpl;
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Lcom/miui/internal/view/menu/MenuItemImpl;
    ...
    invoke-virtual {v8}, Lcom/miui/internal/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    :cond_46
    invoke-virtual {v8}, Lcom/miui/internal/view/menu/MenuItemImpl;->getNumericShortcut()C
...
.method findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    :cond_18
    iget-object v5, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;
    ...
    invoke-virtual {v6}, Lcom/miui/internal/view/menu/MenuItemImpl;->hasSubMenu()Z

    move-result v7

    if-eqz v7, :cond_39

    invoke-virtual {v6}, Lcom/miui/internal/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-virtual {v6}, Lcom/miui/internal/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    :cond_40
    invoke-virtual {v6}, Lcom/miui/internal/view/menu/MenuItemImpl;->getNumericShortcut()C
    ...
    :cond_61
    invoke-virtual {v6}, Lcom/miui/internal/view/menu/MenuItemImpl;->isEnabled()Z
...
.method public flagActionItems()V
    ...
    iget-object v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lcom/miui/internal/view/menu/MenuItemImpl;->isActionButton()Z

    move-result v4

    if-eqz v4, :cond_58

    iget-object v4, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
    ...
    :cond_58
    iget-object v4, p0, Lcom/miui/internal/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
...
.method public hasVisibleItems()Z
    ...
    invoke-virtual {v2}, Lcom/miui/internal/view/menu/MenuItemImpl;->isVisible()Z
...
.method public performItemAction(Landroid/view/MenuItem;I)Z
    ...
    :cond_d
    invoke-virtual {v0}, Lcom/miui/internal/view/menu/MenuItemImpl;->invoke()Z

    move-result v2

    invoke-virtual {v0}, Lcom/miui/internal/view/menu/MenuItemImpl;->getSupportActionProvider()Landroid/view/ActionProvider;
    ...
    :goto_21
    invoke-virtual {v0}, Lcom/miui/internal/view/menu/MenuItemImpl;->hasCollapsibleActionView()Z

    move-result v6

    if-eqz v6, :cond_32

    invoke-virtual {v0}, Lcom/miui/internal/view/menu/MenuItemImpl;->expandActionView()Z
    ...
    invoke-virtual {p0, v4}, Lcom/miui/internal/view/menu/MenuBuilder;->close(Z)V
    ...
    invoke-direct {v1, v6, p0, v0}, Lcom/miui/internal/view/menu/SubMenuBuilder;-><init>(Landroid/content/Context;Lcom/miui/internal/view/menu/MenuBuilder;Lcom/miui/internal/view/menu/MenuItemImpl;)V
    ...
    invoke-virtual {v3, v1}, Landroid/view/ActionProvider;->onPrepareSubMenu(Landroid/view/SubMenu;)V

    :cond_63
    invoke-direct {p0, v1}, Lcom/miui/internal/view/menu/MenuBuilder;->dispatchSubMenuSelected(Lcom/miui/internal/view/menu/SubMenuBuilder;)Z
...
.method public performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, v0, p3}, Lcom/miui/internal/view/menu/MenuBuilder;->performItemAction(Landroid/view/MenuItem;I)Z
...
.method public restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Lcom/miui/internal/view/menu/MenuBuilder;->findItem(I)Landroid/view/MenuItem;
...
.method public saveActionViewStates(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v5, p1}, Lcom/miui/internal/view/menu/SubMenuBuilder;->saveActionViewStates(Landroid/os/Bundle;)V
...
.method setExclusiveItemChecked(Landroid/view/MenuItem;)V
    ...
    :goto_2f
    invoke-virtual {v2, v3}, Lcom/miui/internal/view/menu/MenuItemImpl;->setCheckedInt(Z)V
