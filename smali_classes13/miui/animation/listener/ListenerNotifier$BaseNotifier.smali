...
.method notify(Lmiui/animation/listener/ListenerNotifier$ListenerNode;Ljava/lang/Object;Ljava/util/List;)V
    ...
    iget-object v2, p1, Lmiui/animation/listener/ListenerNotifier$ListenerNode;->relatedProperty:[Lmiui/animation/property/FloatProperty;

    if-eqz v2, :cond_2a

    iget-object v2, p1, Lmiui/animation/listener/ListenerNotifier$ListenerNode;->relatedProperty:[Lmiui/animation/property/FloatProperty;

    iget-object v3, v1, Lmiui/animation/listener/UpdateInfo;->property:Lmiui/animation/property/FloatProperty;

    invoke-static {v2, v3}, Lmiui/animation/utils/CommonUtils;->inArray([Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_2a
    iget-object v2, p0, Lmiui/animation/listener/ListenerNotifier$BaseNotifier;->mUpdateList:Ljava/util/List;
    ...
    :cond_30
    iget-object v0, p0, Lmiui/animation/listener/ListenerNotifier$BaseNotifier;->mUpdateList:Ljava/util/List;

    invoke-virtual {p0, p1, p2, v0}, Lmiui/animation/listener/ListenerNotifier$BaseNotifier;->doNotify(Lmiui/animation/listener/ListenerNotifier$ListenerNode;Ljava/lang/Object;Ljava/util/List;)V
