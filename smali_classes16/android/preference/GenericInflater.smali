...
.method private final createItemFromTag(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;Landroid/util/AttributeSet;)Ljava/lang/Object;
    ...
    move-result-object v0
    :try_end_26
    .catch Landroid/view/InflateException; {:try_start_2 .. :try_end_26} :catch_6a
    .catch Ljava/lang/ClassNotFoundException; {:try_start_2 .. :try_end_26} :catch_49
...
.method public final createItem(Ljava/lang/String;Ljava/lang/String;Landroid/util/AttributeSet;)Ljava/lang/Object;
    ...
    sget-object v4, Landroid/preference/GenericInflater;->mConstructorSignature:[Ljava/lang/Class;
    ...
    sget-object v4, Landroid/preference/GenericInflater;->sConstructorMap:Ljava/util/HashMap;

    invoke-virtual {v4, p1, v0}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_39
    iget-object v3, p0, Landroid/preference/GenericInflater;->mConstructorArgs:[Ljava/lang/Object;
    ...
    move-result-object v1
    :try_end_41
    .catch Ljava/lang/NoSuchMethodException; {:try_start_d .. :try_end_41} :catch_6d
    .catch Ljava/lang/ClassNotFoundException; {:try_start_d .. :try_end_41} :catch_6b
...
.method public inflate(Lorg/xmlpull/v1/XmlPullParser;Landroid/preference/GenericInflater$Parent;Z)Ljava/lang/Object;
    ...
    :try_end_30
    .catch Landroid/view/InflateException; {:try_start_f .. :try_end_30} :catch_84
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_f .. :try_end_30} :catch_75
    .catch Ljava/io/IOException; {:try_start_f .. :try_end_30} :catch_4e
    .catchall {:try_start_f .. :try_end_30} :catchall_87
    ...
    throw v3
    :try_end_4e
    .catch Landroid/view/InflateException; {:try_start_33 .. :try_end_4e} :catch_84
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_33 .. :try_end_4e} :catch_75
    .catch Ljava/io/IOException; {:try_start_33 .. :try_end_4e} :catch_4e
    ...
    monitor-exit v0
    :try_end_89
    .catchall {:try_start_4f .. :try_end_89} :catchall_87
