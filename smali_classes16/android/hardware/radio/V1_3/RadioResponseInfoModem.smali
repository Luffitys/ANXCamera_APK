...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;

    invoke-direct {v5}, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;-><init>()V

    mul-int/lit8 v6, v4, 0x10

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;

    mul-int/lit8 v5, v3, 0x10

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;

    iget v3, p0, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->type:I

    iget v4, v2, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->type:I
    ...
    :cond_1b
    iget v3, p0, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->serial:I

    iget v4, v2, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->serial:I
    ...
    :cond_22
    iget v3, p0, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->error:I

    iget v4, v2, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->error:I
    ...
    :cond_29
    iget-boolean v3, p0, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->isEnabled:Z

    iget-boolean v4, v2, Landroid/hardware/radio/V1_3/RadioResponseInfoModem;->isEnabled:Z
