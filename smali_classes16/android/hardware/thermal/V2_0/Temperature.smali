...
.field public throttlingStatus:I
...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/thermal/V2_0/Temperature;

    invoke-direct {v5}, Landroid/hardware/thermal/V2_0/Temperature;-><init>()V

    mul-int/lit8 v6, v4, 0x20

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/thermal/V2_0/Temperature;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/thermal/V2_0/Temperature;

    mul-int/lit8 v5, v3, 0x20

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/thermal/V2_0/Temperature;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget v3, p0, Landroid/hardware/thermal/V2_0/Temperature;->type:I

    iget v4, v2, Landroid/hardware/thermal/V2_0/Temperature;->type:I
    ...
    :cond_1b
    iget-object v3, p0, Landroid/hardware/thermal/V2_0/Temperature;->name:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/thermal/V2_0/Temperature;->name:Ljava/lang/String;
    ...
    :cond_26
    iget v3, p0, Landroid/hardware/thermal/V2_0/Temperature;->value:F
    ...
    :cond_2f
    iget v3, p0, Landroid/hardware/thermal/V2_0/Temperature;->throttlingStatus:I

    iget v4, v2, Landroid/hardware/thermal/V2_0/Temperature;->throttlingStatus:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v2, v0, Landroid/hardware/thermal/V2_0/Temperature;->throttlingStatus:I
