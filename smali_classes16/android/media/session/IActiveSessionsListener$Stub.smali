...
.method public static asInterface(Landroid/os/IBinder;)Landroid/media/session/IActiveSessionsListener;
    ...
    check-cast v1, Landroid/media/session/IActiveSessionsListener;
...
.method public static getDefaultImpl()Landroid/media/session/IActiveSessionsListener;
    .registers 1

    sget-object v0, Landroid/media/session/IActiveSessionsListener$Stub$Proxy;->sDefaultImpl:Landroid/media/session/IActiveSessionsListener;
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_5
    const-string/jumbo v0, "onActiveSessionsChanged"

    return-object v0
.end method

.method public static setDefaultImpl(Landroid/media/session/IActiveSessionsListener;)Z
    .registers 3
    ...
    sput-object p0, Landroid/media/session/IActiveSessionsListener$Stub$Proxy;->sDefaultImpl:Landroid/media/session/IActiveSessionsListener;
...
.method public getTransactionName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/media/session/IActiveSessionsListener$Stub;->getDefaultTransactionName(I)Ljava/lang/String;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v2}, Landroid/media/session/IActiveSessionsListener$Stub;->onActiveSessionsChanged(Ljava/util/List;)V
