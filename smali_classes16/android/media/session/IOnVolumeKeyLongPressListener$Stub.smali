...
.method public static asInterface(Landroid/os/IBinder;)Landroid/media/session/IOnVolumeKeyLongPressListener;
    ...
    check-cast v1, Landroid/media/session/IOnVolumeKeyLongPressListener;
...
.method public static getDefaultImpl()Landroid/media/session/IOnVolumeKeyLongPressListener;
    .registers 1

    sget-object v0, Landroid/media/session/IOnVolumeKeyLongPressListener$Stub$Proxy;->sDefaultImpl:Landroid/media/session/IOnVolumeKeyLongPressListener;
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_5
    const-string/jumbo v0, "onVolumeKeyLongPress"

    return-object v0
.end method

.method public static setDefaultImpl(Landroid/media/session/IOnVolumeKeyLongPressListener;)Z
    .registers 3
    ...
    sput-object p0, Landroid/media/session/IOnVolumeKeyLongPressListener$Stub$Proxy;->sDefaultImpl:Landroid/media/session/IOnVolumeKeyLongPressListener;
...
.method public getTransactionName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/media/session/IOnVolumeKeyLongPressListener$Stub;->getDefaultTransactionName(I)Ljava/lang/String;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_26
    invoke-virtual {p0, v2}, Landroid/media/session/IOnVolumeKeyLongPressListener$Stub;->onVolumeKeyLongPress(Landroid/view/KeyEvent;)V
