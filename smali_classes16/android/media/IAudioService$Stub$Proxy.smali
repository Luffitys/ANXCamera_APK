...
# static fields
.field public static sDefaultImpl:Landroid/media/IAudioService;
...
.method public createAudioRecordForLoopback(Landroid/os/ParcelFileDescriptor;J)Landroid/os/IBinder;
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/media/IAudioService;->createAudioRecordForLoopback(Landroid/os/ParcelFileDescriptor;J)Landroid/os/IBinder;
...
.method public createAudioRecordForLoopbackWithClient(Landroid/os/ParcelFileDescriptor;JLandroid/os/IBinder;)Landroid/os/IBinder;
    ...
    invoke-interface {v3, p1, p2, p3, p4}, Landroid/media/IAudioService;->createAudioRecordForLoopbackWithClient(Landroid/os/ParcelFileDescriptor;JLandroid/os/IBinder;)Landroid/os/IBinder;
...
.method public getDeviceStreamVolume(II)I
    ...
    invoke-interface {v3, p1, p2}, Landroid/media/IAudioService;->getDeviceStreamVolume(II)I
...
.method public getNotificationUri(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v3, p1}, Landroid/media/IAudioService;->getNotificationUri(Ljava/lang/String;)Ljava/lang/String;
...
.method public getPlayerVolume(Ljava/lang/String;)F
    ...
    invoke-interface {v3, p1}, Landroid/media/IAudioService;->getPlayerVolume(Ljava/lang/String;)F
...
.method public registerAudioPolicy(Landroid/media/audiopolicy/AudioPolicyConfig;Landroid/media/audiopolicy/IAudioPolicyCallback;ZZZZLandroid/media/projection/IMediaProjection;)Ljava/lang/String;
    ...
    :try_end_50
    .catchall {:try_start_9 .. :try_end_50} :catchall_8e
    ...
    move-result-object v1
    :try_end_75
    .catchall {:try_start_51 .. :try_end_75} :catchall_8c
...
.method public requestAudioFocus(Landroid/media/AudioAttributes;ILandroid/os/IBinder;Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;Ljava/lang/String;ILandroid/media/audiopolicy/IAudioPolicyCallback;I)I
    ...
    :try_end_1d
    .catchall {:try_start_a .. :try_end_1d} :catchall_97
    ...
    move-result v1
    :try_end_7c
    .catchall {:try_start_24 .. :try_end_7c} :catchall_93
...
.method public setPlayerVolume(Landroid/media/AudioPlaybackConfiguration;F)V
    ...
    invoke-virtual {p1, v0, v2}, Landroid/media/AudioPlaybackConfiguration;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/media/IAudioService;->setPlayerVolume(Landroid/media/AudioPlaybackConfiguration;F)V
    :try_end_35
