...
# static fields
.field private static final DESCRIPTOR:Ljava/lang/String; = "android.os.IClientCallback"

.field static final TRANSACTION_onClients:I = 0x1
...
.method public static asInterface(Landroid/os/IBinder;)Landroid/os/IClientCallback;
    .registers 3
    ...
    check-cast v1, Landroid/os/IClientCallback;

    return-object v1

    :cond_14
    new-instance v1, Landroid/os/IClientCallback$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/os/IClientCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V

    return-object v1
.end method

.method public static getDefaultImpl()Landroid/os/IClientCallback;
    .registers 1
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_5
    const-string/jumbo v0, "onClients"

    return-object v0
.end method

.method public static setDefaultImpl(Landroid/os/IClientCallback;)Z
    .registers 3
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_23
    invoke-virtual {p0, v2, v3}, Landroid/os/IClientCallback$Stub;->onClients(Landroid/os/IBinder;Z)V
