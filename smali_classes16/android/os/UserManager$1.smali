...
# virtual methods
.method protected recompute(Ljava/lang/Integer;)Ljava/lang/Boolean;
    .registers 4

    :try_start_0
    iget-object v0, p0, Landroid/os/UserManager$1;->this$0:Landroid/os/UserManager;

    # getter for: Landroid/os/UserManager;->mService:Landroid/os/IUserManager;
    ...
    invoke-interface {v0, v1}, Landroid/os/IUserManager;->isUserUnlocked(I)Z
...
.method protected bridge synthetic recompute(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroid/os/UserManager$1;->recompute(Ljava/lang/Integer;)Ljava/lang/Boolean;
