...
# static fields
.field private static final DESCRIPTOR:Ljava/lang/String; = "android.os.incremental.IIncrementalServiceConnector"

.field static final TRANSACTION_setStorageParams:I = 0x1
...
.method public static asInterface(Landroid/os/IBinder;)Landroid/os/incremental/IIncrementalServiceConnector;
    .registers 3
    ...
    check-cast v1, Landroid/os/incremental/IIncrementalServiceConnector;

    return-object v1

    :cond_14
    new-instance v1, Landroid/os/incremental/IIncrementalServiceConnector$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/os/incremental/IIncrementalServiceConnector$Stub$Proxy;-><init>(Landroid/os/IBinder;)V

    return-object v1
.end method

.method public static getDefaultImpl()Landroid/os/incremental/IIncrementalServiceConnector;
    .registers 1
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_5
    const-string/jumbo v0, "setStorageParams"

    return-object v0
.end method

.method public static setDefaultImpl(Landroid/os/incremental/IIncrementalServiceConnector;)Z
    .registers 3
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_1f
    invoke-virtual {p0, v2}, Landroid/os/incremental/IIncrementalServiceConnector$Stub;->setStorageParams(Z)I
