.class public final Landroid/sysprop/HdmiProperties;
...
.method public static device_type()Ljava/util/List;
    .registers 2
    ...
    sget-object v1, Landroid/sysprop/-$$Lambda$HdmiProperties$CNvkqLuyqfShLeSsOJAfUN4Iwzg;->INSTANCE:Landroid/sysprop/-$$Lambda$HdmiProperties$CNvkqLuyqfShLeSsOJAfUN4Iwzg;

    invoke-static {v1, v0}, Landroid/sysprop/HdmiProperties;->tryParseList(Ljava/util/function/Function;Ljava/lang/String;)Ljava/util/List;
...
.method private static formatList(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v3}, Landroid/sysprop/HdmiProperties;->escape(Ljava/lang/String;)Ljava/lang/String;
...
.method static synthetic lambda$device_type$0(Ljava/lang/String;)Ljava/lang/Integer;
    .registers 2

    invoke-static {p0}, Landroid/sysprop/HdmiProperties;->tryParseInteger(Ljava/lang/String;)Ljava/lang/Integer;
...
.method public static set_menu_language()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-static {v0}, Landroid/sysprop/HdmiProperties;->tryParseBoolean(Ljava/lang/String;)Ljava/lang/Boolean;
...
.method private static tryParseEnumList(Ljava/lang/Class;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v4}, Landroid/sysprop/HdmiProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;
