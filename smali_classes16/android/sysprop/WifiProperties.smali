.class public final Landroid/sysprop/WifiProperties;
.super Ljava/lang/Object;
.source "WifiProperties.java"
...
.method private static formatList(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v3}, Landroid/sysprop/WifiProperties;->escape(Ljava/lang/String;)Ljava/lang/String;
...
.method public static start_supplicant()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v0, "ctl.start$supplicant"

    invoke-static {v0}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Landroid/sysprop/WifiProperties;->tryParseBoolean(Ljava/lang/String;)Ljava/lang/Boolean;
...
.method public static start_supplicant(Ljava/lang/Boolean;)V
    .registers 3
    ...
    :goto_9
    const-string v1, "ctl.start$supplicant"
...
.method public static stop_supplicant()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v0, "ctl.stop$supplicant"
...
.method public static stop_supplicant(Ljava/lang/Boolean;)V
    .registers 3
    ...
    :goto_9
    const-string v1, "ctl.stop$supplicant"
...
.method private static tryParseEnumList(Ljava/lang/Class;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v4}, Landroid/sysprop/WifiProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;
