.class public final Landroid/sysprop/ContactsProperties;
.super Ljava/lang/Object;
.source "ContactsProperties.java"
...
.method public static aggregate_contacts()Ljava/util/Optional;
    .registers 2
    ...
    const-string/jumbo v0, "sync.contacts.aggregate"

    invoke-static {v0}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Landroid/sysprop/ContactsProperties;->tryParseBoolean(Ljava/lang/String;)Ljava/lang/Boolean;
...
.method public static debug_scan_all_packages()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v0, "debug.cp2.scan_all_packages"
...
.method public static display_photo_size()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-static {v0}, Landroid/sysprop/ContactsProperties;->tryParseInteger(Ljava/lang/String;)Ljava/lang/Integer;
...
.method private static formatList(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v3}, Landroid/sysprop/ContactsProperties;->escape(Ljava/lang/String;)Ljava/lang/String;
...
.method public static keep_stale_account_data()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v0, "debug.contacts.ksad"
...
.method public static thumbnail_size()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v0, "contacts.thumbnail_size"
...
.method private static tryParseEnumList(Ljava/lang/Class;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v4}, Landroid/sysprop/ContactsProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;
