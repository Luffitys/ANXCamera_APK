.class public final Landroid/sysprop/InitProperties;
.super Ljava/lang/Object;
.source "InitProperties.java"
...
.method private static formatList(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v3}, Landroid/sysprop/InitProperties;->escape(Ljava/lang/String;)Ljava/lang/String;
...
.method public static is_userspace_reboot_supported()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v0, "init.userspace_reboot.is_supported"

    invoke-static {v0}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Landroid/sysprop/InitProperties;->tryParseBoolean(Ljava/lang/String;)Ljava/lang/Boolean;
...
.method private static tryParseEnumList(Ljava/lang/Class;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v4}, Landroid/sysprop/InitProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;
...
.method public static userspace_reboot_in_progress()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string/jumbo v0, "sys.init.userspace_reboot.in_progress"
...
.method public static userspace_reboot_in_progress(Ljava/lang/Boolean;)V
    .registers 3
    ...
    :goto_10
    const-string/jumbo v1, "sys.init.userspace_reboot.in_progress"
