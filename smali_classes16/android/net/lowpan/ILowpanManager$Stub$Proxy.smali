...
# static fields
.field public static sDefaultImpl:Landroid/net/lowpan/ILowpanManager;
...
.method public addInterface(Landroid/net/lowpan/ILowpanInterface;)V
    ...
    invoke-static {}, Landroid/net/lowpan/ILowpanManager$Stub;->getDefaultImpl()Landroid/net/lowpan/ILowpanManager;
    ...
    invoke-interface {v3, p1}, Landroid/net/lowpan/ILowpanManager;->addInterface(Landroid/net/lowpan/ILowpanInterface;)V
    :try_end_2f
...
.method public addListener(Landroid/net/lowpan/ILowpanManagerListener;)V
    ...
    invoke-interface {v3, p1}, Landroid/net/lowpan/ILowpanManager;->addListener(Landroid/net/lowpan/ILowpanManagerListener;)V
    :try_end_2f
    .catchall {:try_start_8 .. :try_end_2f} :catchall_41
...
.method public getInterface(Ljava/lang/String;)Landroid/net/lowpan/ILowpanInterface;
    ...
    invoke-interface {v3, p1}, Landroid/net/lowpan/ILowpanManager;->getInterface(Ljava/lang/String;)Landroid/net/lowpan/ILowpanInterface;
...
.method public getInterfaceList()[Ljava/lang/String;
    ...
    invoke-interface {v3}, Landroid/net/lowpan/ILowpanManager;->getInterfaceList()[Ljava/lang/String;
...
.method public removeInterface(Landroid/net/lowpan/ILowpanInterface;)V
    ...
    invoke-interface {v3, p1}, Landroid/net/lowpan/ILowpanManager;->removeInterface(Landroid/net/lowpan/ILowpanInterface;)V
    :try_end_2f
    .catchall {:try_start_8 .. :try_end_2f} :catchall_41
...
.method public removeListener(Landroid/net/lowpan/ILowpanManagerListener;)V
    ...
    invoke-interface {v3, p1}, Landroid/net/lowpan/ILowpanManager;->removeListener(Landroid/net/lowpan/ILowpanManagerListener;)V
    :try_end_2f
    .catchall {:try_start_8 .. :try_end_2f} :catchall_41
