...
.method static constructor <clinit>()V
    ...
    const-string v2, "UNKNOWN_PORTRAIT"
    ...
    invoke-direct/range {v1 .. v6}, Landroid/print/PrintAttributes$MediaSize;-><init>(Ljava/lang/String;Ljava/lang/String;III)V

    sput-object v0, Landroid/print/PrintAttributes$MediaSize;->UNKNOWN_PORTRAIT:Landroid/print/PrintAttributes$MediaSize;

    new-instance v0, Landroid/print/PrintAttributes$MediaSize;

    const-string v8, "UNKNOWN_LANDSCAPE"
    ...
    invoke-direct/range {v7 .. v12}, Landroid/print/PrintAttributes$MediaSize;-><init>(Ljava/lang/String;Ljava/lang/String;III)V

    sput-object v0, Landroid/print/PrintAttributes$MediaSize;->UNKNOWN_LANDSCAPE:Landroid/print/PrintAttributes$MediaSize;

    new-instance v0, Landroid/print/PrintAttributes$MediaSize;

    const-string v2, "ISO_A0"
    ...
    const-string v2, "NA_GOVT_LETTER"
    ...
    const-string v2, "NA_JUNIOR_LEGAL"
    ...
    const-string v2, "OM_JUURO_KU_KAI"
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;III)V
    ...
    const-string v0, "heightMils cannot be less than or equal to zero."
    ...
    :goto_3a
    const-string v0, "label cannot be empty."
...
.method static createFromParcel(Landroid/os/Parcel;)Landroid/print/PrintAttributes$MediaSize;
    ...
    new-instance v7, Landroid/print/PrintAttributes$MediaSize;
...
.method public asLandscape()Landroid/print/PrintAttributes$MediaSize;
    ...
    iget-object v3, p0, Landroid/print/PrintAttributes$MediaSize;->mLabel:Ljava/lang/String;
    ...
    iget v7, p0, Landroid/print/PrintAttributes$MediaSize;->mLabelResId:I

    move-object v1, v0

    invoke-direct/range {v1 .. v7}, Landroid/print/PrintAttributes$MediaSize;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;III)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v4, v2, Landroid/print/PrintAttributes$MediaSize;->mWidthMils:I
    ...
    iget v4, v2, Landroid/print/PrintAttributes$MediaSize;->mHeightMils:I
...
.method public getLabel(Landroid/content/pm/PackageManager;)Ljava/lang/String;
    ...
    move-result-object v0
    :try_end_18
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_c .. :try_end_18} :catch_19
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_c .. :try_end_18} :catch_19
    ...
    const-string v2, "Could not load resouce"
