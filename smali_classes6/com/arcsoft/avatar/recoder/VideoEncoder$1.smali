...
.method public run()V
    ...
    iget-object v1, v1, Lcom/arcsoft/avatar/recoder/BaseEncoder;->i:Landroid/media/MediaCodec;
    ...
    iget-boolean v2, v1, Lcom/arcsoft/avatar/recoder/BaseEncoder;->d:Z
    ...
    :try_start_1
    invoke-virtual {v1}, Lcom/arcsoft/avatar/recoder/BaseEncoder;->lock()V

    :goto_1
    iget-object v1, p0, Lcom/arcsoft/avatar/recoder/VideoEncoder$1;->a:Lcom/arcsoft/avatar/recoder/VideoEncoder;

    iget-object v1, v1, Lcom/arcsoft/avatar/recoder/BaseEncoder;->s:Lcom/arcsoft/avatar/recoder/FrameQueue;

    invoke-virtual {v1}, Lcom/arcsoft/avatar/recoder/FrameQueue;->queueSize()I
    ...
    iget-boolean v1, v1, Lcom/arcsoft/avatar/recoder/BaseEncoder;->d:Z
    :try_end_1
    ...
    iget-object v1, v1, Lcom/arcsoft/avatar/recoder/BaseEncoder;->r:Ljava/util/concurrent/locks/Condition;
    ...
    invoke-virtual {v1}, Lcom/arcsoft/avatar/recoder/FrameQueue;->getFrameForConsumer()Lcom/arcsoft/avatar/recoder/FrameItem;
    ...
    invoke-virtual {v3}, Lcom/arcsoft/avatar/recoder/BaseEncoder;->drain()V
    ...
    iget v4, v2, Lcom/arcsoft/avatar/recoder/FrameItem;->mFrameIndex:I
    ...
    iget-wide v2, v2, Lcom/arcsoft/avatar/recoder/FrameItem;->a:J
    ...
    invoke-static {v2}, Lcom/arcsoft/avatar/recoder/VideoEncoder;->c(Lcom/arcsoft/avatar/recoder/VideoEncoder;)Lcom/arcsoft/avatar/gl/GLRender;

    move-result-object v2

    invoke-virtual {v1}, Lcom/arcsoft/avatar/gl/GLFramebuffer;->getTextureId()I

    move-result v1

    invoke-virtual {v2, v1}, Lcom/arcsoft/avatar/gl/GLRender;->renderWithTextureId(I)V
    ...
    invoke-static {v4, v1}, Lcom/arcsoft/avatar/util/CodecLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_6
    ...
    :goto_5
    iget-object p0, p0, Lcom/arcsoft/avatar/recoder/VideoEncoder$1;->a:Lcom/arcsoft/avatar/recoder/VideoEncoder;
    ...
    iput-boolean v0, v1, Lcom/arcsoft/avatar/recoder/BaseEncoder;->a:Z

    iget-object v0, v1, Lcom/arcsoft/avatar/recoder/BaseEncoder;->i:Landroid/media/MediaCodec;

    invoke-virtual {v0}, Landroid/media/MediaCodec;->signalEndOfInputStream()V

    iget-object v0, p0, Lcom/arcsoft/avatar/recoder/VideoEncoder$1;->a:Lcom/arcsoft/avatar/recoder/VideoEncoder;

    invoke-virtual {v0}, Lcom/arcsoft/avatar/recoder/BaseEncoder;->drain()V
    ...
    invoke-static {p0}, Lcom/arcsoft/avatar/recoder/VideoEncoder;->a(Lcom/arcsoft/avatar/recoder/VideoEncoder;)Lcom/arcsoft/avatar/gl/EGLWrapper;

    move-result-object p0

    invoke-virtual {p0}, Lcom/arcsoft/avatar/gl/EGLWrapper;->makeUnCurrent()V
    ...
    invoke-interface {p0, v1, v0}, Lcom/arcsoft/avatar/recoder/RecordingListener;->onRecordingListener(ILjava/lang/Object;)V
