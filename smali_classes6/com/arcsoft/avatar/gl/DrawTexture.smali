.class public Lcom/arcsoft/avatar/gl/DrawTexture;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->a:Ljava/lang/String;

    const-string v0, "#version 310 es\nlayout(location = 0) in vec2 arc_tex_coord;\nlayout(location = 1) in vec2 aPosition;\nout vec2 vTextureCoord;\nvoid main()\n{\n   vTextureCoord = arc_tex_coord;\n   gl_Position = vec4(aPosition, 1.0, 1.0);\n} "

    iput-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->b:Ljava/lang/String;

    const/4 v0, -0x1

    iput v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->c:I

    iput v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I

    iput v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->e:I

    iput v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->f:I

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->g:[I

    const/4 v0, 0x1

    new-array v0, v0, [I

    iput-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->h:[I
    ...
    iput-object v1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->k:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_1

    iput-object v1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->l:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_2

    iput-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->m:[F
...
.method private a(Z)V
    ...
    iget-object p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->m:[F

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->l:[F

    :goto_0
    iget-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->g:[I
    ...
    iget-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->h:[I
    ...
    iget-object v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->g:[I

    invoke-static {v0, v2, v3}, Landroid/opengl/GLES30;->glGenBuffers(I[II)V

    iget-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->k:[F
    ...
    iget-object v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->k:[F

    invoke-virtual {v0, v2}, Ljava/nio/FloatBuffer;->put([F)Ljava/nio/FloatBuffer;

    invoke-virtual {v0, v3}, Ljava/nio/FloatBuffer;->position(I)Ljava/nio/Buffer;

    iget v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I
    ...
    iput v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->e:I
    ...
    iget v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->e:I

    invoke-static {v0}, Landroid/opengl/GLES30;->glEnableVertexAttribArray(I)V

    iget v5, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->e:I
    ...
    iput-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->i:Ljava/nio/FloatBuffer;

    invoke-virtual {v0, p1}, Ljava/nio/FloatBuffer;->put([F)Ljava/nio/FloatBuffer;

    iget-object v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->i:Ljava/nio/FloatBuffer;

    invoke-virtual {v0, v3}, Ljava/nio/FloatBuffer;->position(I)Ljava/nio/Buffer;

    iput-boolean v3, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->j:Z

    iget v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I
    ...
    iget p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->f:I

    invoke-static {p1}, Landroid/opengl/GLES30;->glEnableVertexAttribArray(I)V

    iget v5, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->f:I
...
.method private b(Z)V
    ...
    iget-boolean v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->j:Z

    if-nez v2, :cond_0

    iget-object p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->i:Ljava/nio/FloatBuffer;

    iget-object v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->m:[F

    invoke-virtual {p1, v2}, Ljava/nio/FloatBuffer;->put([F)Ljava/nio/FloatBuffer;

    iput-boolean v0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->j:Z
    ...
    iget-boolean p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->j:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->i:Ljava/nio/FloatBuffer;

    iget-object v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->l:[F

    invoke-virtual {p1, v2}, Ljava/nio/FloatBuffer;->put([F)Ljava/nio/FloatBuffer;

    iput-boolean v1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->j:Z

    :goto_0
    iget-object p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->g:[I
    ...
    iget-object p0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->i:Ljava/nio/FloatBuffer;
...
.method public DrawSurfaceWithTex(I)V
    ...
    iget p0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->c:I
...
.method public initGLFun(Z)V
    ...
    iput v2, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I
    ...
    iget v1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I
    ...
    iput v4, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I

    :cond_2
    invoke-direct {p0, p1}, Lcom/arcsoft/avatar/gl/DrawTexture;->a(Z)V

    iget p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I
    ...
    iput p1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->c:I
...
.method public unInitGLFun()V
    ...
    iput v1, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->d:I
    ...
    iget-object p0, p0, Lcom/arcsoft/avatar/gl/DrawTexture;->g:[I
