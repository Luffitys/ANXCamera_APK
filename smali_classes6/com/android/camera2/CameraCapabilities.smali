...
.method static synthetic OooO00o(Ljava/util/List;Landroid/hardware/camera2/params/StreamConfiguration;)V
    .locals 1
...
.method private getStreamConfigurations(I)Ljava/util/List;
    ...
    invoke-virtual {v2}, LOooO0O0/OooO0o0/OooO00o/OooO0Oo;->o00oOo0o()Z
...
.method public getOptimalMasterBokehSize(Ljava/lang/String;)Landroid/util/Size;
    ...
    invoke-static {p0}, Lcom/android/camera2/CameraCapabilities;->convertToSizes([I)[Landroid/util/Size;
    ...
    const-string p1, "could not get master optimal size"
...
.method public getOptimalSlaveBokehSize(Ljava/lang/String;)Landroid/util/Size;
    ...
    const-string p1, "could not get slave optimal size"
...
.method public getSatFusionCalibrationDataArray()[Lcom/android/camera2/vendortag/struct/SatFusionCalibrationData;
    ...
    check-cast p0, [Lcom/android/camera2/vendortag/struct/SatFusionCalibrationData;
...
.method public getSuperNightLimitSize()Ljava/util/List;
    ...
    sget-object v2, Lcom/android/camera2/vendortag/CameraCharacteristicsVendorTags;->SUPER_NIGHT_LIMIT_STREAM:Lcom/android/camera2/vendortag/VendorTag;
    ...
    invoke-virtual {v0}, Landroid/hardware/camera2/params/StreamConfiguration;->getWidth()I

    move-result v3

    invoke-virtual {v0}, Landroid/hardware/camera2/params/StreamConfiguration;->getHeight()I

    move-result v0

    invoke-direct {v2, v3, v0}, Lcom/android/camera/CameraSize;-><init>(II)V
...
.method public getSupportFakeSatJpegSizes()Ljava/util/List;
    .locals 4
    ...
    const-string v0, "getSupportFakeSatJpegSizes: tag undefined"
    ...
    const-string v3, "getSupportFakeSatJpegSizes: "
...
.method public getSupportFakeSatYuvSizes()Ljava/util/List;
    .locals 4
    ...
    const-string v0, "getSupportFakeSatYuvSizes: tag undefined"
    ...
    sget-object v1, Lcom/android/camera2/vendortag/CameraCharacteristicsVendorTags;->FAKE_SAT_YUV_SIZE:Lcom/android/camera2/vendortag/VendorTag;
    ...
    const-string v3, "getSupportFakeSatYuvSizes: "
...
.method public getSupportedHeicOutputStreamSizes()Ljava/util/List;
    ...
    new-instance v1, Lcom/android/camera2/OooO00o;

    invoke-direct {v1, v0}, Lcom/android/camera2/OooO00o;-><init>(Ljava/util/List;)V
...
.method public isQcfaMode()Z
    ...
    invoke-virtual {p0, v0}, LOooO0O0/OooO0o0/OooO00o/OooO0Oo;->OooOOO0(Z)Z
...
.method public isSupportFlashHdr()Z
    ...
    sget-object v0, Lcom/android/camera2/vendortag/CameraCharacteristicsVendorTags;->SUPPORT_FLASH_HDR:Lcom/android/camera2/vendortag/VendorTag;
...
.method public isSupportLightTripartite()Z
    ...
    sget-object v0, Lcom/android/camera2/vendortag/CameraCharacteristicsVendorTags;->TRIPARTITE_LIGHT:Lcom/android/camera2/vendortag/VendorTag;
...
.method public isSupportMegviiDualBokeh()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera2/CameraCapabilities;->supportDualBokehVendor()I

    move-result p0

    sget-object v0, Lcom/android/camera/BokehVendor;->MEGVII_DUAL_BOKEH:Lcom/android/camera/BokehVendor;
...
.method public isVideoHDR10PlusSupported()Z
    .locals 3

    sget-object v0, Lcom/android/camera2/vendortag/CameraCharacteristicsVendorTags;->SUPPORT_VIDEO_HDR10:Lcom/android/camera2/vendortag/VendorTag;
    ...
    const-string v0, "isVideoHDR10Supported: false, because tag undefined"
    ...
    const-string v2, "isVideoHDR10+Supported: "
...
.method public isVideoHDR10Supported()Z
    .locals 3
    ...
    const-string v2, "isVideoHDR10Supported: "
...
.method public supportDualBokehVendor()I
    .locals 1
    ...
    :cond_0
    sget-object p0, Lcom/android/camera/BokehVendor;->ARCSOFT_DUAL_BOKEH:Lcom/android/camera/BokehVendor;
...
.method public supportFakeSat()Z
    .locals 3
    ...
    invoke-virtual {p0}, Lcom/android/camera2/CameraCapabilities;->getSupportFakeSatYuvSizes()Ljava/util/List;

    move-result-object v0

    invoke-virtual {p0}, Lcom/android/camera2/CameraCapabilities;->getSupportFakeSatJpegSizes()Ljava/util/List;
