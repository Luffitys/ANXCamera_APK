...
.method configParallelSession(Landroid/util/Size;)V
    ...
    const-string v2, "configParallelSession:  streamNbr = "
    ...
    const-string v4, "configParallelSession: "
    ...
    invoke-direct {v1, v0, p1, v2, v3}, Lcom/xiaomi/engine/BufferFormat;-><init>(IIILcom/xiaomi/engine/GraphDescriptorBean;)V
    ...
    invoke-virtual {v3}, Lcom/android/camera2/MiCamera2;->getBokehDepthSize()Lcom/android/camera/CameraSize;

    move-result-object v3

    invoke-virtual {v2, v1, v3}, Lcom/android/camera/LocalParallelService$LocalBinder;->configCaptureSession(Lcom/xiaomi/engine/BufferFormat;Lcom/android/camera/CameraSize;)V
...
.method configParallelSession(Landroid/util/Size;I)V
    ...
    invoke-direct {v0, v3, v1, v2, p2}, Lcom/xiaomi/engine/GraphDescriptorBean;-><init>(IIZI)V
    ...
    invoke-direct {v0, v3, v2, v2, p2}, Lcom/xiaomi/engine/GraphDescriptorBean;-><init>(IIZI)V

    :goto_1
    iget-object p2, p0, Lcom/android/camera2/MiCamera2Shot;->mMiCamera:Lcom/android/camera2/MiCamera2;

    invoke-virtual {p2}, Lcom/android/camera2/MiCamera2;->isFakeSatEnable()Z
    ...
    invoke-virtual {p2}, Lcom/android/camera2/MiCamera2;->getFakeSatOutputSize()Lcom/android/camera/CameraSize;
    ...
    invoke-virtual {p1}, Lcom/android/camera2/MiCamera2;->getFakeSatOutputSize()Lcom/android/camera/CameraSize;
    ...
    const-string v3, "configParallelSession: streamSize = "
    ...
    invoke-direct {v1, p2, p1, v2, v0}, Lcom/xiaomi/engine/BufferFormat;-><init>(IIILcom/xiaomi/engine/GraphDescriptorBean;)V
...
.method protected isSatFusionShotEnabled()Z
    ...
    invoke-virtual {v3}, Lcom/android/camera2/MiCamera2;->getSATSubCameraIds()[I
    ...
    const-string v0, "SAT_FUSION_T_UT_COMBINATION: "
