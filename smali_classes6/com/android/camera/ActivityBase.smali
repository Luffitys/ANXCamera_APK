...
.method public gotoGallery()V
    ...
    invoke-virtual {v2}, Lcom/android/camera/ThumbnailUpdater;->getViewRect()Landroid/graphics/Rect;

    move-result-object v2

    if-eqz v2, :cond_3

    const-string v8, "anchor_pivot_x"
    ...
    const-string v8, "anchor_pivot_y"
    ...
    :cond_4
    invoke-static {p0, v6}, Lcom/android/camera/Util;->enableSeamlessRotation(Landroid/app/Activity;Z)V

    goto :goto_2

    :cond_5
    :goto_1
    invoke-static {p0, v7}, Lcom/android/camera/Util;->enableSeamlessRotation(Landroid/app/Activity;Z)V
    ...
    invoke-virtual {v4, v2, v8}, Landroid/content/Intent;->putExtra(Ljava/lang/String;F)Landroid/content/Intent;
    ...
    invoke-virtual {v4, v0, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[J)Landroid/content/Intent;
    ...
    invoke-interface {v0, v6}, Lcom/android/camera/module/Module;->enableCameraControls(Z)V
...
.method protected onDestroy()V
    ...
    invoke-virtual {v0}, LOooO0O0/OooO0o0/OooO00o/OooO0Oo;->o00OO0()Z
...
.method protected onPause()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/ActivityBase;->isStreaming()Z
    ...
    const-string v4, "onPause: isStreaming = "
