...
.method private drawAnimationMask(Lcom/android/camera/effect/draw_mode/DrawAttribute;)V
    ...
    iget v4, p1, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mWidth:I

    iget v5, p1, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mHeight:I
...
.method private updatePreviewSecondRender(Z)Z
    ...
    sget p1, Lcom/android/camera/effect/FilterInfo;->FILTER_ID_STICKER:I

    invoke-direct {p0, p1}, Lcom/android/camera/effect/renders/EffectRenderGroup;->fetchRender(I)Lcom/android/camera/effect/renders/Render;
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera/effect/renders/RenderGroup;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {v7, v2}, Lcom/android/camera/effect/renders/RenderGroup;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {v2, v4}, Lcom/android/camera/effect/renders/RenderGroup;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    iget-object p1, p0, Lcom/android/camera/effect/renders/EffectRenderGroup;->mPreviewSecondRender:Lcom/android/camera/effect/renders/PipeRender;

    invoke-virtual {p1, v5}, Lcom/android/camera/effect/renders/RenderGroup;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {p1, v6}, Lcom/android/camera/effect/renders/RenderGroup;->addRender(Lcom/android/camera/effect/renders/Render;)V
    ...
    invoke-virtual {p1, v1, v2}, Lcom/android/camera/effect/renders/PipeRender;->setFrameBufferSize(II)V
