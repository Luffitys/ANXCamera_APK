...
.method private drawTexture(Lcom/android/gallery3d/ui/BasicTexture;FFFF[F)V
    .locals 1
    ...
    invoke-direct/range {p0 .. p6}, Lcom/android/camera/effect/renders/BasicRender;->drawTextureInternal(Lcom/android/gallery3d/ui/BasicTexture;FFFF[F)V
...
.method private drawTexture(Lcom/android/gallery3d/ui/BasicTexture;Landroid/graphics/RectF;Landroid/graphics/RectF;)V
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/camera/effect/renders/BasicRender;->drawTextureInternal(Lcom/android/gallery3d/ui/BasicTexture;FFFF[F)V
...
.method private drawTextureInternal(Lcom/android/gallery3d/ui/BasicTexture;FFFF[F)V
    .locals 8
    ...
    :cond_5
    invoke-static {p1, v7, v3, p6, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V
...
.method private fillRect(FFFFI)V
    ...
    invoke-direct {p0, p5, v0}, Lcom/android/camera/effect/renders/BasicRender;->initGLPaint(IZ)V
    ...
    invoke-static {p1, v1, v1, v1, p2}, Landroid/opengl/GLES20;->glUniform4f(IFFFF)V
...
.method private fillRoundRect(FFFFILjava/nio/FloatBuffer;)V
    .locals 2
    ...
    invoke-direct {p0, p6}, Lcom/android/camera/effect/renders/BasicRender;->initRoundAttribPointer(Ljava/nio/FloatBuffer;)V
    ...
    invoke-virtual {p6}, Ljava/nio/FloatBuffer;->capacity()I
...
.method public draw(Lcom/android/camera/effect/draw_mode/DrawAttribute;)Z
    ...
    iget v0, p1, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I

    int-to-float v4, v0

    iget v0, p1, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mWidth:I

    int-to-float v5, v0

    iget v0, p1, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mHeight:I

    int-to-float v6, v0

    iget v7, p1, Lcom/android/camera/effect/draw_mode/DrawRoundFillRectAttribute;->mColor:I

    iget-object v8, p1, Lcom/android/camera/effect/draw_mode/DrawRoundFillRectAttribute;->mVertexBuffer:Ljava/nio/FloatBuffer;

    move-object v2, p0

    invoke-direct/range {v2 .. v8}, Lcom/android/camera/effect/renders/BasicRender;->fillRoundRect(FFFFILjava/nio/FloatBuffer;)V
    ...
    iget-object v3, p1, Lcom/android/camera/effect/draw_mode/DrawBasicTexAttribute;->mBasicTexture:Lcom/android/gallery3d/ui/BasicTexture;
    ...
    iget-object v8, p1, Lcom/android/camera/effect/draw_mode/DrawBasicTexAttribute;->mTextureTransform:[F

    move-object v2, p0

    invoke-direct/range {v2 .. v8}, Lcom/android/camera/effect/renders/BasicRender;->drawTexture(Lcom/android/gallery3d/ui/BasicTexture;FFFF[F)V
    ...
    iget v7, p1, Lcom/android/camera/effect/draw_mode/DrawFillRectAttribute;->mColor:I

    move-object v2, p0

    invoke-direct/range {v2 .. v7}, Lcom/android/camera/effect/renders/BasicRender;->fillRect(FFFFI)V
