...
.method private decompressNativeResource(Landroid/content/Context;Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p2, p0}, Lcom/android/camera/resource/BaseResourceItem;->simpleVerification(Ljava/lang/String;)Z

    move-result p3

    if-eqz p3, :cond_0

    invoke-virtual {p2, p0}, Lcom/android/camera/resource/BaseResourceItem;->onDecompressFinished(Ljava/lang/String;)V

    return-void

    :cond_0
    iget-object p3, p2, Lcom/android/camera/resource/BaseResourceItem;->uri:Ljava/lang/String;
    ...
    invoke-static {p1, p3, p0, p4}, Lcom/android/camera/Util;->verifyAssetZip(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V
...
.method private decompressSdcardResource(Landroid/content/Context;Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/String;Z)V
    .locals 0
    ...
    invoke-virtual {p2, p1, p0}, Lcom/android/camera/resource/BaseResourceItem;->onDecompressFailed(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p0, p2}, Lcom/android/camera/Util;->verifySdcardZip(Ljava/lang/String;Ljava/lang/String;I)V
...
.method public decompressResource(Landroid/content/Context;Lcom/android/camera/resource/BaseResourceList;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, v0, p3, p4}, Lcom/android/camera/resource/SimpleNativeResourceInfoListFillRequest;->decompressNativeResource(Landroid/content/Context;Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/String;Z)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, v0, p3, p4}, Lcom/android/camera/resource/SimpleNativeResourceInfoListFillRequest;->decompressSdcardResource(Landroid/content/Context;Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/String;Z)V
...
.method protected scheduleRequest(Lcom/android/camera/resource/ResponseListener;Lcom/android/camera/resource/BaseResourceList;)V
    ...
    invoke-virtual {p2, v3}, Lcom/android/camera/resource/BaseResourceList;->setLocalVersion(Ljava/lang/String;)V
