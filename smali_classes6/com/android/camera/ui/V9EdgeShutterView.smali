...
.method private couldTouch(II)Z
    ...
    sget p1, Lcom/android/camera/ui/V9EdgeShutterView;->NEAR_THRESHOLD:I
...
.method private getViewState()Ljava/lang/String;
    ...
    const-string p0, "View state mleft=%d mtop=%d width=%d height=%d mVisibleState=%d getVisibility()=%d"
...
.method private isDeviceStateReady(III)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/Camera;->isStable()Z

    move-result v0

    const/4 v1, 0x0

    const-string v2, "CameraEdgeShutterView"

    if-nez v0, :cond_0

    const-string p0, "Device is not stable, ignore edgetouch"
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/Camera;->getCapturePosture()I
    ...
    const-string v5, "Device post wrong, y is too big, capturePosture="
    ...
    const-string v4, "Device post wrong, touching bottom edge, capturePosture="
...
.method private reviseLocation(IILandroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    const-string v1, "flyto reviseLocation x"
    ...
    sget p0, Lcom/android/camera/ui/V9EdgeShutterView;->VIEW_WIDTH:I
...
.method public onCreate()V
    ...
    iget-object p0, p0, Lcom/android/camera/ui/V9EdgeShutterView;->mOuterPaint:Landroid/graphics/Paint;
