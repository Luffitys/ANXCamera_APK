...
.field public static final EV_ADJUST_ALPHA:I = 0xcc
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->mEvAdjustAlphaAnimator:Landroid/animation/ValueAnimator;
...
.method private synthetic OooO00o(Landroid/animation/ValueAnimator;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera/ui/drawable/focus/CameraFocusPaintEvAdjust;->setLineAlpha(I)V
...
.method public synthetic OooO0O0(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->OooO00o(Landroid/animation/ValueAnimator;)V

    return-void
.end method

.method public cancelEvAdjustAlphaAnim()V
    .locals 1

    iget-object v0, p0, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->mEvAdjustAlphaAnimator:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/ui/drawable/focus/CameraFocusPaintEvAdjust;->setLineAlpha(I)V
...
.method public setEvAdjustVisible(I)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->cancelEvAdjustAlphaAnim()V
...
.method public startEvAdjustAlphaAnim()V
    .locals 3
    ...
    new-instance v1, Lcom/android/camera/ui/drawable/focus/OooO00o;

    invoke-direct {v1, p0}, Lcom/android/camera/ui/drawable/focus/OooO00o;-><init>(Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;)V

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object p0, p0, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->mEvAdjustAlphaAnimator:Landroid/animation/ValueAnimator;
...
.method public startFocusSuccessAnimation(IZ)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->mTouchDownAnimator:Landroid/animation/ValueAnimator;

    invoke-direct {p0, p2}, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->isAnimatorRunning(Landroid/animation/Animator;)Z

    move-result p2

    if-eqz p2, :cond_1

    iput p1, p0, Lcom/android/camera/ui/drawable/focus/CameraFocusAnimateDrawable;->pendingState:I
