...
.field private mItfGvOnItemClickListener:Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ItfGvOnItemClickListener;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ItfGvOnItemClickListener;)V
    .locals 2
    ...
    new-instance v0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$1;

    invoke-direct {v0, p0}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$1;-><init>(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mLevelDatas:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object p2, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mItfGvOnItemClickListener:Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ItfGvOnItemClickListener;

    return-void
.end method

.method private synthetic OooO00o(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;ILcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;ILandroid/view/View;)V
    .locals 0

    iget-object p3, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mClickCheck:Lcom/android/camera/fragment/mimoji/ClickCheck;

    if-eqz p3, :cond_0

    invoke-virtual {p3}, Lcom/android/camera/fragment/mimoji/ClickCheck;->checkClickable()Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p4}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->onGvItemClick(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;II)V
...
.method static synthetic access$100(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;)Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ItfGvOnItemClickListener;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mItfGvOnItemClickListener:Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ItfGvOnItemClickListener;

    return-object p0
.end method

.method static synthetic access$200(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;)Lcom/android/camera/fragment/mimoji/MimojiThumbnailRenderThread;
    .locals 0
...
.method private onGvItemClick(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;II)V
    .locals 4
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mLevelDatas:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v2, v0, v3}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->setInnerConfigSelectIndex(IF)V

    if-eqz v1, :cond_0

    invoke-virtual {p0, p1, p2, p3}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->updateSelectView(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;II)V

    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mAvatarConfigItemClick:Lcom/android/camera/fragment/mimoji/AvatarConfigItemClick;

    const/4 p1, 0x0

    invoke-interface {p0, v1, p1, p2}, Lcom/android/camera/fragment/mimoji/AvatarConfigItemClick;->onConfigItemClick(Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;ZI)V

    goto :goto_0

    :cond_0
    sget-object p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->TAG:Ljava/lang/String;
...
.method private declared-synchronized showColor(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;Lcom/android/camera/fragment/mimoji/MimojiLevelBean;I)V
    ...
    :try_start_0
    iget-object v0, p1, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;->mColorRecycleView:Landroidx/recyclerview/widget/RecyclerView;
...
# virtual methods
.method public synthetic OooO0O0(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;ILcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;ILandroid/view/View;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->OooO00o(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;ILcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;ILandroid/view/View;)V
...
.method public getIsColorNeedNotify()Z
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->isColorNeedNotify:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public getItemCount()I
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mLevelDatas:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mLevelDatas:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public notifyThumbnailUpdate(III)V
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mLevelDatas:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mMimojiThumbnailAdapters:Ljava/util/List;

    invoke-interface {p0, p2}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;
...
.method public onBindViewHolder(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;I)V
    ...
    iget-object v1, p1, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;->mThumbnailGV:Landroidx/recyclerview/widget/RecyclerView;

    invoke-direct {p0, p1, v0, p2}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->showColor(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;Lcom/android/camera/fragment/mimoji/MimojiLevelBean;I)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mMimojiLevelBean:Lcom/android/camera/fragment/mimoji/MimojiLevelBean;
    ...
    check-cast v2, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;
    ...
    iget-object v6, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v8, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v9, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object p1, p1, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter$ViewHolder;->mColorRecycleView:Landroidx/recyclerview/widget/RecyclerView;
    ...
    new-instance p1, Lcom/android/camera/fragment/mimoji/OooO0OO;

    invoke-direct {p1, p0, v2, p2}, Lcom/android/camera/fragment/mimoji/OooO0OO;-><init>(Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;I)V
...
.method public declared-synchronized refreshData(Ljava/util/List;ZZ)V
    ...
    :cond_5
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->setLevelDatas(Ljava/util/List;)V
    ...
    iget-object p3, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mLevelDatas:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v0, v0, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->configTypeName:Ljava/lang/String;

    invoke-direct {p1, p2, p3, v0}, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;-><init>(Landroid/content/Context;ILjava/lang/String;)V
...
.method public updateSelectView(Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;II)V
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/EditLevelListAdapter;->mMimojiLevelBean:Lcom/android/camera/fragment/mimoji/MimojiLevelBean;

    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->configTypeName:Ljava/lang/String;
    ...
    iget-object p0, p2, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->thumnails:Ljava/util/ArrayList;

    invoke-virtual {p0, p3}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;

    iget p0, p0, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;->configID:I
    ...
    iget p0, p2, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->configType:I
    ...
    invoke-virtual {p1, p0, p2}, Lcom/android/camera/fragment/mimoji/MimojiThumbnailRecyclerAdapter;->setSelectItem(II)V
