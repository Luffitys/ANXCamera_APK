...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lcom/android/camera/fragment/mimoji/MimojiHelper;->DATA_DIR:Ljava/lang/String;
    ...
    const-string v1, "cartoon_xiaomi_v_0_0_0_27"
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mSubConfigs:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public static getMimojiConfigValue(Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigValue;)Ljava/util/Map;
    .locals 3
    ...
    iget p0, p0, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigValue;->configEarringStyleID:I
...
.method public declared-synchronized addAvatarConfig(Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigInfo;)Lcom/arcsoft/avatar/AvatarEngine;
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mAvatar:Lcom/arcsoft/avatar/AvatarEngine;
    :try_end_1
...
.method public clear()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mSubConfigs:Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-virtual {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;->clear()V

    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mColorLayoutManagerMap:Ljava/util/Map;
...
.method public getASAvatarConfigValue()Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigValue;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mASAvatarConfigValue:Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigValue;

    return-object p0
.end method

.method public declared-synchronized getAvatar()Lcom/arcsoft/avatar/AvatarEngine;
    .locals 1
...
.method public getConfigTypeForIndex(I)Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mTypeList:Ljava/util/ArrayList;

    invoke-virtual {p0, p1}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/arcsoft/avatar/AvatarConfig$ASAvatarConfigType;
...
.method public getInnerConfigSelectIndex(I)F
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mInnerConfigSelectMap:Ljava/util/Map;
...
.method public getInterruptIndex(I)I
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mInterruptMap:Ljava/util/Map;
...
.method public getSelectConfigList()Ljava/util/ArrayList;
    ...
    iget p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mSelectType:I
...
.method public getSelectTypeIndex()I
    ...
    iget p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mSelectTabIndex:I
...
.method public getSubConfigList(Landroid/content/Context;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->getSubConfigList(Landroid/content/Context;I)Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public getSubConfigList(Landroid/content/Context;I)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v2, p2, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->thumnails:Ljava/util/ArrayList;
    ...
    iput-object v1, p2, Lcom/android/camera/fragment/mimoji/MimojiLevelBean;->configTypeName:Ljava/lang/String;

    iget-object v1, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mSubConfigs:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mSubConfigs:Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-virtual {p1, p2}, Ljava/util/concurrent/CopyOnWriteArrayList;->add(Ljava/lang/Object;)Z

    :cond_b
    :goto_1
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mSubConfigs:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public isColorSelected()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mIsColorSelected:Z
...
.method public isNeedUpdate(I)Z
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mNeedUpdateMap:Ljava/util/Map;
    ...
    iget-boolean p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mAllNeedUpdate:Z
...
.method public putConfigList(ILjava/util/ArrayList;)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/fragment/mimoji/AvatarEngineManager;->mConfigMap:Ljava/util/Map;
