...
.method private getBrightIsAndroidP(Landroid/view/WindowManager$LayoutParams;Landroid/app/Activity;)Ljava/lang/Integer;
    ...
    :catch_0
    iget-object v2, p0, Lcom/android/camera/CameraBrightness$CameraBrightnessTask;->mCallbackWeakReference:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v3}, LOooO0O0/OooO0o0/OooO00o/OooO0Oo;->o00OoO00()Z
    ...
    iget-boolean v3, p0, Lcom/android/camera/CameraBrightness$CameraBrightnessTask;->mPaused:Z
    ...
    invoke-interface {v2, v3}, Lcom/android/camera/CameraBrightnessCallback;->setPreviousBrightnessMode(I)V
    ...
    :cond_1
    :goto_0
    invoke-interface {v2}, Lcom/android/camera/CameraBrightnessCallback;->getPreviousBrightnessMode()I
    ...
    iput v4, p0, Lcom/android/camera/CameraBrightness$CameraBrightnessTask;->mBrightnessMode:I
    ...
    iget v5, p0, Lcom/android/camera/CameraBrightness$CameraBrightnessTask;->mBrightnessMode:I

    if-ne v5, v4, :cond_5

    iget-boolean p2, p0, Lcom/android/camera/CameraBrightness$CameraBrightnessTask;->mUseDefaultValue:Z

    const/high16 v4, 0x3f000000    # 0.5f

    if-nez p2, :cond_3

    iget-boolean p2, p0, Lcom/android/camera/CameraBrightness$CameraBrightnessTask;->mPaused:Z

    if-nez p2, :cond_3

    iget p2, p0, Lcom/android/camera/CameraBrightness$CameraBrightnessTask;->mScreenAutoBrightnessRatioInner:F
    ...
    invoke-interface {v2, v4}, Lcom/android/camera/CameraBrightnessCallback;->adjustBrightnessInAutoMode(F)V
    ...
    invoke-interface {v2, v0}, Lcom/android/camera/CameraBrightnessCallback;->adjustBrightnessInAutoMode(F)V
    ...
    invoke-interface {v2, p0}, Lcom/android/camera/CameraBrightnessCallback;->setBrightness(I)V
    ...
    invoke-static {v2, v5}, Lmiui/util/ReflectionUtils;->findField(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    invoke-static {p2, v5}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    ...
    const-string p0, "android P -> doInBackground brightness unchanged"
