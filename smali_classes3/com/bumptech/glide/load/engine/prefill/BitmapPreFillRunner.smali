...
# static fields
.field private static final Gh:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;

.field static final Hh:I = 0x4

.field static final INITIAL_BACKOFF_MS:J = 0x28L

.field static final Ih:J
...
# instance fields
.field private final Ch:Lcom/bumptech/glide/load/engine/prefill/b;

.field private final Dh:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Gh:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;
    ...
    sput-wide v0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Ih:J
...
.method public constructor <init>(Lcom/bumptech/glide/load/engine/bitmap_recycle/d;Lcom/bumptech/glide/load/engine/a/o;Lcom/bumptech/glide/load/engine/prefill/b;)V
    ...
    sget-object v4, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Gh:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;
...
.method constructor <init>(Lcom/bumptech/glide/load/engine/bitmap_recycle/d;Lcom/bumptech/glide/load/engine/a/o;Lcom/bumptech/glide/load/engine/prefill/b;Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Eh:Ljava/util/Set;

    const-wide/16 v0, 0x28

    iput-wide v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Fh:J

    iput-object p1, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Eb:Lcom/bumptech/glide/load/engine/bitmap_recycle/d;

    iput-object p2, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Fb:Lcom/bumptech/glide/load/engine/a/o;

    iput-object p3, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Ch:Lcom/bumptech/glide/load/engine/prefill/b;

    iput-object p4, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Dh:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;
...
.method private ca()J
    ...
    iget-wide v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Fh:J

    const-wide/16 v2, 0x4

    mul-long/2addr v2, v0

    sget-wide v4, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Ih:J

    invoke-static {v2, v3, v4, v5}, Ljava/lang/Math;->min(JJ)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Fh:J
...
.method private i(J)Z
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Dh:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;
...
.method private qm()J
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Fb:Lcom/bumptech/glide/load/engine/a/o;

    invoke-interface {v0}, Lcom/bumptech/glide/load/engine/a/o;->getMaxSize()J

    move-result-wide v0

    iget-object p0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Fb:Lcom/bumptech/glide/load/engine/a/o;
...
.method allocate()Z
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Dh:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;
    ...
    :cond_0
    :goto_0
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Ch:Lcom/bumptech/glide/load/engine/prefill/b;
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Eh:Ljava/util/Set;
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Eb:Lcom/bumptech/glide/load/engine/bitmap_recycle/d;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->qm()J
    ...
    iget-object v6, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Fb:Lcom/bumptech/glide/load/engine/a/o;

    iget-object v7, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Eb:Lcom/bumptech/glide/load/engine/bitmap_recycle/d;
    ...
    :cond_2
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Eb:Lcom/bumptech/glide/load/engine/bitmap_recycle/d;
    ...
    :cond_3
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->_d:Z

    if-nez v0, :cond_4

    iget-object p0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->Ch:Lcom/bumptech/glide/load/engine/prefill/b;
...
.method public cancel()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->_d:Z
