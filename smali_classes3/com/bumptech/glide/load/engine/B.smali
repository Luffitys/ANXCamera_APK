...
.field private _f:Lcom/bumptech/glide/load/engine/C;
...
.method constructor <init>(Lcom/bumptech/glide/load/engine/g;Lcom/bumptech/glide/load/engine/f$a;)V
    ...
    iput v0, p0, Lcom/bumptech/glide/load/engine/B;->Zf:I

    iput-object p1, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;
...
.method private Zl()Z
    ...
    iget v0, p0, Lcom/bumptech/glide/load/engine/B;->Ee:I

    iget-object p0, p0, Lcom/bumptech/glide/load/engine/B;->De:Ljava/util/List;
...
.method public K()Z
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v0}, Lcom/bumptech/glide/load/engine/g;->ri()Ljava/util/List;
    ...
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v1}, Lcom/bumptech/glide/load/engine/g;->vi()Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/g;->wi()Ljava/lang/Class;
    ...
    :cond_1
    :goto_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/B;->De:Ljava/util/List;

    const/4 v4, 0x1

    if-eqz v3, :cond_5

    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/B;->Zl()Z
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/B;->Fe:Lcom/bumptech/glide/load/model/t$a;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/B;->De:Ljava/util/List;

    iget v1, p0, Lcom/bumptech/glide/load/engine/B;->Ee:I

    add-int/lit8 v3, v1, 0x1

    iput v3, p0, Lcom/bumptech/glide/load/engine/B;->Ee:I
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/B;->Ge:Ljava/io/File;

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v3}, Lcom/bumptech/glide/load/engine/g;->getWidth()I

    move-result v3

    iget-object v5, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v5}, Lcom/bumptech/glide/load/engine/g;->getHeight()I

    move-result v5

    iget-object v6, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/B;->Fe:Lcom/bumptech/glide/load/model/t$a;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/B;->Ae:Lcom/bumptech/glide/load/engine/g;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/B;->Fe:Lcom/bumptech/glide/load/model/t$a;
    ...
    :cond_5
    :goto_2
    iget v3, p0, Lcom/bumptech/glide/load/engine/B;->Zf:I

    add-int/2addr v3, v4

    iput v3, p0, Lcom/bumptech/glide/load/engine/B;->Zf:I
    ...
    iget v3, p0, Lcom/bumptech/glide/load/engine/B;->Be:I

    add-int/2addr v3, v4

    iput v3, p0, Lcom/bumptech/glide/load/engine/B;->Be:I
    ...
    :cond_6
    iput v2, p0, Lcom/bumptech/glide/load/engine/B;->Zf:I
    ...
    iget v4, p0, Lcom/bumptech/glide/load/engine/B;->Zf:I
    ...
    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/g;->pa()Lcom/bumptech/glide/load/engine/bitmap_recycle/b;
    ...
    iput-object v13, p0, Lcom/bumptech/glide/load/engine/B;->_f:Lcom/bumptech/glide/load/engine/C;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/B;->_f:Lcom/bumptech/glide/load/engine/C;

    invoke-interface {v4, v5}, Lcom/bumptech/glide/load/engine/a/a;->b(Lcom/bumptech/glide/load/c;)Ljava/io/File;

    move-result-object v4

    iput-object v4, p0, Lcom/bumptech/glide/load/engine/B;->Ge:Ljava/io/File;

    iget-object v4, p0, Lcom/bumptech/glide/load/engine/B;->Ge:Ljava/io/File;

    if-eqz v4, :cond_1

    iput-object v3, p0, Lcom/bumptech/glide/load/engine/B;->Ce:Lcom/bumptech/glide/load/c;
    ...
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/B;->De:Ljava/util/List;

    iput v2, p0, Lcom/bumptech/glide/load/engine/B;->Ee:I
...
.method public b(Ljava/lang/Exception;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/B;->_f:Lcom/bumptech/glide/load/engine/C;

    iget-object p0, p0, Lcom/bumptech/glide/load/engine/B;->Fe:Lcom/bumptech/glide/load/model/t$a;

    iget-object p0, p0, Lcom/bumptech/glide/load/model/t$a;->li:Lcom/bumptech/glide/load/a/d;

    sget-object v2, Lcom/bumptech/glide/load/DataSource;->Qp:Lcom/bumptech/glide/load/DataSource;
...
.method public b(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/B;->Ce:Lcom/bumptech/glide/load/c;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/B;->Fe:Lcom/bumptech/glide/load/model/t$a;

    iget-object v3, v2, Lcom/bumptech/glide/load/model/t$a;->li:Lcom/bumptech/glide/load/a/d;

    sget-object v4, Lcom/bumptech/glide/load/DataSource;->Qp:Lcom/bumptech/glide/load/DataSource;
