...
.method private Om()Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->nj()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->mj()I
...
.method private Sm()V
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Mm()Z
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->oj()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Om()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->tj()Landroid/graphics/drawable/Drawable;
...
.method private a(Lcom/bumptech/glide/load/engine/A;Ljava/lang/Object;Lcom/bumptech/glide/load/DataSource;)V
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Pm()Z
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Rm()V
...
.method private a(Lcom/bumptech/glide/load/engine/GlideException;I)V
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/util/a/g;->Zj()V
    ...
    :cond_2
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Sm()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Qm()V
...
.method private oj()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->oj()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->pj()I
...
.method private tj()Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->tj()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->uj()I
...
.method public a(Lcom/bumptech/glide/load/engine/A;Lcom/bumptech/glide/load/DataSource;)V
    ...
    :cond_1
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Nm()Z
...
.method public b(II)V
    ...
    invoke-direct {v15, v0}, Lcom/bumptech/glide/request/SingleRequest;->I(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->vj()F
    ...
    invoke-virtual {v9}, Lcom/bumptech/glide/request/f;->si()Lcom/bumptech/glide/load/engine/o;
    ...
    invoke-virtual {v11}, Lcom/bumptech/glide/request/f;->Ej()Z

    move-result v11

    iget-object v12, v15, Lcom/bumptech/glide/request/SingleRequest;->zc:Lcom/bumptech/glide/request/f;

    invoke-virtual {v12}, Lcom/bumptech/glide/request/f;->xi()Z
    ...
    invoke-virtual {v14}, Lcom/bumptech/glide/request/f;->Aj()Z
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->xj()Z
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->wj()Z

    move-result v16

    iget-object v0, v1, Lcom/bumptech/glide/request/SingleRequest;->zc:Lcom/bumptech/glide/request/f;

    invoke-virtual {v0}, Lcom/bumptech/glide/request/f;->qj()Z
    ...
    invoke-direct {v1, v0}, Lcom/bumptech/glide/request/SingleRequest;->I(Ljava/lang/String;)V
...
.method public begin()V
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Km()V
    ...
    invoke-direct {p0, v0}, Lcom/bumptech/glide/request/SingleRequest;->I(Ljava/lang/String;)V
...
.method public clear()V
    ...
    :cond_1
    invoke-direct {p0}, Lcom/bumptech/glide/request/SingleRequest;->Lm()Z
