...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/HardwareConfigModem;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/HardwareConfigModem;-><init>()V

    mul-int/lit8 v6, v4, 0x14

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/HardwareConfigModem;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/HardwareConfigModem;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget v3, p0, Landroid/hardware/radio/V1_0/HardwareConfigModem;->rilModel:I

    iget v4, v2, Landroid/hardware/radio/V1_0/HardwareConfigModem;->rilModel:I
    ...
    :cond_1b
    iget v3, p0, Landroid/hardware/radio/V1_0/HardwareConfigModem;->rat:I

    iget v4, v2, Landroid/hardware/radio/V1_0/HardwareConfigModem;->rat:I
    ...
    :cond_22
    iget v3, p0, Landroid/hardware/radio/V1_0/HardwareConfigModem;->maxVoice:I

    iget v4, v2, Landroid/hardware/radio/V1_0/HardwareConfigModem;->maxVoice:I
    ...
    :cond_29
    iget v3, p0, Landroid/hardware/radio/V1_0/HardwareConfigModem;->maxData:I

    iget v4, v2, Landroid/hardware/radio/V1_0/HardwareConfigModem;->maxData:I
    ...
    :cond_30
    iget v3, p0, Landroid/hardware/radio/V1_0/HardwareConfigModem;->maxStandby:I

    iget v4, v2, Landroid/hardware/radio/V1_0/HardwareConfigModem;->maxStandby:I
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Landroid/hardware/radio/V1_0/HardwareConfigModem;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/hardware/radio/V1_0/HardwareConfigModem;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
