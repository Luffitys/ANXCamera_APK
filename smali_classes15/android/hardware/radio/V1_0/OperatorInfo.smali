...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/OperatorInfo;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/OperatorInfo;-><init>()V

    mul-int/lit8 v6, v4, 0x38

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/OperatorInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/OperatorInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v3, Landroid/hardware/radio/V1_0/OperatorInfo;
    ...
    check-cast v2, Landroid/hardware/radio/V1_0/OperatorInfo;

    iget-object v3, p0, Landroid/hardware/radio/V1_0/OperatorInfo;->alphaLong:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/OperatorInfo;->alphaLong:Ljava/lang/String;
    ...
    :cond_1f
    iget-object v3, p0, Landroid/hardware/radio/V1_0/OperatorInfo;->alphaShort:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/OperatorInfo;->alphaShort:Ljava/lang/String;
    ...
    :cond_2a
    iget-object v3, p0, Landroid/hardware/radio/V1_0/OperatorInfo;->operatorNumeric:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/OperatorInfo;->operatorNumeric:Ljava/lang/String;
    ...
    :cond_35
    iget v3, p0, Landroid/hardware/radio/V1_0/OperatorInfo;->status:I

    iget v4, v2, Landroid/hardware/radio/V1_0/OperatorInfo;->status:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v2, v0, Landroid/hardware/radio/V1_0/OperatorInfo;->status:I
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Landroid/hardware/radio/V1_0/OperatorInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/hardware/radio/V1_0/OperatorInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
