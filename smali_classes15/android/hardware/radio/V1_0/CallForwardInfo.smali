...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/CallForwardInfo;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/CallForwardInfo;-><init>()V

    mul-int/lit8 v6, v4, 0x28

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/CallForwardInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/CallForwardInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/radio/V1_0/CallForwardInfo;

    iget v3, p0, Landroid/hardware/radio/V1_0/CallForwardInfo;->status:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CallForwardInfo;->status:I
    ...
    :cond_1b
    iget v3, p0, Landroid/hardware/radio/V1_0/CallForwardInfo;->reason:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CallForwardInfo;->reason:I
    ...
    :cond_22
    iget v3, p0, Landroid/hardware/radio/V1_0/CallForwardInfo;->serviceClass:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CallForwardInfo;->serviceClass:I
    ...
    :cond_29
    iget v3, p0, Landroid/hardware/radio/V1_0/CallForwardInfo;->toa:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CallForwardInfo;->toa:I
    ...
    :cond_30
    iget-object v3, p0, Landroid/hardware/radio/V1_0/CallForwardInfo;->number:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/CallForwardInfo;->number:Ljava/lang/String;
    ...
    :cond_3b
    iget v3, p0, Landroid/hardware/radio/V1_0/CallForwardInfo;->timeSeconds:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CallForwardInfo;->timeSeconds:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v4, v0, Landroid/hardware/radio/V1_0/CallForwardInfo;->reason:I
    ...
    iput v4, v0, Landroid/hardware/radio/V1_0/CallForwardInfo;->serviceClass:I
    ...
    iput v2, v0, Landroid/hardware/radio/V1_0/CallForwardInfo;->timeSeconds:I
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Landroid/hardware/radio/V1_0/CallForwardInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/hardware/radio/V1_0/CallForwardInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
