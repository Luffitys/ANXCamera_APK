...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;-><init>()V

    mul-int/lit8 v6, v4, 0x4

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v3, p0, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->isPresent:Z
    ...
    :cond_1b
    iget-byte v3, p0, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->signalType:B

    iget-byte v4, v2, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->signalType:B
    ...
    :cond_22
    iget-byte v3, p0, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->alertPitch:B

    iget-byte v4, v2, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->alertPitch:B
    ...
    :cond_29
    iget-byte v3, p0, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->signal:B

    iget-byte v4, v2, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->signal:B
