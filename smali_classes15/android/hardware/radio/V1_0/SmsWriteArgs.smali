...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/SmsWriteArgs;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/SmsWriteArgs;-><init>()V

    mul-int/lit8 v6, v4, 0x28

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/SmsWriteArgs;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/radio/V1_0/SmsWriteArgs;

    mul-int/lit8 v5, v3, 0x28

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/SmsWriteArgs;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/radio/V1_0/SmsWriteArgs;

    iget v3, p0, Landroid/hardware/radio/V1_0/SmsWriteArgs;->status:I

    iget v4, v2, Landroid/hardware/radio/V1_0/SmsWriteArgs;->status:I
    ...
    :cond_1b
    iget-object v3, p0, Landroid/hardware/radio/V1_0/SmsWriteArgs;->pdu:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/SmsWriteArgs;->pdu:Ljava/lang/String;
    ...
    :cond_26
    iget-object v3, p0, Landroid/hardware/radio/V1_0/SmsWriteArgs;->smsc:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/SmsWriteArgs;->smsc:Ljava/lang/String;
