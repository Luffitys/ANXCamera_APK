...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/SuppSvcNotification;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/SuppSvcNotification;-><init>()V

    mul-int/lit8 v6, v4, 0x20

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/SuppSvcNotification;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/radio/V1_0/SuppSvcNotification;

    mul-int/lit8 v5, v3, 0x20

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/SuppSvcNotification;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/radio/V1_0/SuppSvcNotification;

    iget-boolean v3, p0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->isMT:Z

    iget-boolean v4, v2, Landroid/hardware/radio/V1_0/SuppSvcNotification;->isMT:Z
    ...
    :cond_1b
    iget v3, p0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->code:I

    iget v4, v2, Landroid/hardware/radio/V1_0/SuppSvcNotification;->code:I
    ...
    :cond_22
    iget v3, p0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->index:I

    iget v4, v2, Landroid/hardware/radio/V1_0/SuppSvcNotification;->index:I
    ...
    :cond_29
    iget v3, p0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->type:I

    iget v4, v2, Landroid/hardware/radio/V1_0/SuppSvcNotification;->type:I
    ...
    :cond_30
    iget-object v3, p0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->number:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/SuppSvcNotification;->number:Ljava/lang/String;
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput-boolean v4, v0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->isMT:Z
    ...
    iput v4, v0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->code:I
    ...
    iput v4, v0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->index:I
    ...
    iput v4, v0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->type:I
    ...
    iput-object v6, v0, Landroid/hardware/radio/V1_0/SuppSvcNotification;->number:Ljava/lang/String;
