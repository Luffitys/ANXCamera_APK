...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget v3, p0, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->fromServiceId:I

    iget v4, v2, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->fromServiceId:I
    ...
    :cond_1b
    iget v3, p0, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->toServiceId:I

    iget v4, v2, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->toServiceId:I
    ...
    :cond_22
    iget v3, p0, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->fromCodeScheme:I

    iget v4, v2, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->fromCodeScheme:I
    ...
    :cond_29
    iget v3, p0, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->toCodeScheme:I

    iget v4, v2, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->toCodeScheme:I
    ...
    :cond_30
    iget-boolean v3, p0, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->selected:Z

    iget-boolean v4, v2, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->selected:Z
...
.method public final hashCode()I
    ...
    iget-boolean v1, p0, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->selected:Z
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-boolean v2, p0, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->selected:Z
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/hardware/radio/V1_0/GsmBroadcastSmsConfigInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
