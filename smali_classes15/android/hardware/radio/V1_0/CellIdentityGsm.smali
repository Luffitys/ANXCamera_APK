...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/CellIdentityGsm;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/CellIdentityGsm;-><init>()V

    mul-int/lit8 v6, v4, 0x30

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/CellIdentityGsm;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/CellIdentityGsm;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v3, Landroid/hardware/radio/V1_0/CellIdentityGsm;
    ...
    check-cast v2, Landroid/hardware/radio/V1_0/CellIdentityGsm;

    iget-object v3, p0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->mcc:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/CellIdentityGsm;->mcc:Ljava/lang/String;
    ...
    :cond_1f
    iget-object v3, p0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->mnc:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/CellIdentityGsm;->mnc:Ljava/lang/String;
    ...
    :cond_2a
    iget v3, p0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->lac:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CellIdentityGsm;->lac:I
    ...
    :cond_31
    iget v3, p0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->cid:I
    ...
    :cond_38
    iget v3, p0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->arfcn:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CellIdentityGsm;->arfcn:I
    ...
    :cond_3f
    iget-byte v3, p0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->bsic:B

    iget-byte v4, v2, Landroid/hardware/radio/V1_0/CellIdentityGsm;->bsic:B
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v2, v0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->lac:I
    ...
    iput v2, v0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->cid:I
    ...
    iput v2, v0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->arfcn:I
    ...
    iput-byte v2, v0, Landroid/hardware/radio/V1_0/CellIdentityGsm;->bsic:B
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Landroid/hardware/radio/V1_0/CellIdentityGsm;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/hardware/radio/V1_0/CellIdentityGsm;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
