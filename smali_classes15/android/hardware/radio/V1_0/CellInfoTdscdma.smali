...
# instance fields
.field public cellIdentityTdscdma:Landroid/hardware/radio/V1_0/CellIdentityTdscdma;

.field public signalStrengthTdscdma:Landroid/hardware/radio/V1_0/TdScdmaSignalStrength;
...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/CellInfoTdscdma;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/CellInfoTdscdma;-><init>()V

    mul-int/lit8 v6, v4, 0x38

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v3, Landroid/hardware/radio/V1_0/CellInfoTdscdma;
    ...
    check-cast v2, Landroid/hardware/radio/V1_0/CellInfoTdscdma;

    iget-object v3, p0, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->cellIdentityTdscdma:Landroid/hardware/radio/V1_0/CellIdentityTdscdma;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->cellIdentityTdscdma:Landroid/hardware/radio/V1_0/CellIdentityTdscdma;
    ...
    :cond_1f
    iget-object v3, p0, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->signalStrengthTdscdma:Landroid/hardware/radio/V1_0/TdScdmaSignalStrength;

    iget-object v4, v2, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->signalStrengthTdscdma:Landroid/hardware/radio/V1_0/TdScdmaSignalStrength;
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/hardware/radio/V1_0/CellInfoTdscdma;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
