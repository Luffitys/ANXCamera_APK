...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/radio/V1_0/CellIdentityCdma;

    invoke-direct {v5}, Landroid/hardware/radio/V1_0/CellIdentityCdma;-><init>()V

    mul-int/lit8 v6, v4, 0x14

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_0/CellIdentityCdma;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/radio/V1_0/CellIdentityCdma;

    mul-int/lit8 v5, v3, 0x14

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_0/CellIdentityCdma;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/radio/V1_0/CellIdentityCdma;

    iget v3, p0, Landroid/hardware/radio/V1_0/CellIdentityCdma;->networkId:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CellIdentityCdma;->networkId:I
    ...
    :cond_1b
    iget v3, p0, Landroid/hardware/radio/V1_0/CellIdentityCdma;->systemId:I
    ...
    iget v4, v2, Landroid/hardware/radio/V1_0/CellIdentityCdma;->baseStationId:I
    ...
    :cond_29
    iget v3, p0, Landroid/hardware/radio/V1_0/CellIdentityCdma;->longitude:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CellIdentityCdma;->longitude:I
    ...
    :cond_30
    iget v3, p0, Landroid/hardware/radio/V1_0/CellIdentityCdma;->latitude:I

    iget v4, v2, Landroid/hardware/radio/V1_0/CellIdentityCdma;->latitude:I
