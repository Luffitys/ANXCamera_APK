...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/contexthub/V1_0/IContexthubCallback;
    ...
    instance-of v3, v2, Landroid/hardware/contexthub/V1_0/IContexthubCallback;

    if-eqz v3, :cond_15

    move-object v0, v2

    check-cast v0, Landroid/hardware/contexthub/V1_0/IContexthubCallback;

    return-object v0

    :cond_15
    new-instance v3, Landroid/hardware/contexthub/V1_0/IContexthubCallback$Proxy;

    invoke-direct {v3, p0}, Landroid/hardware/contexthub/V1_0/IContexthubCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_1a
    invoke-interface {v3}, Landroid/hardware/contexthub/V1_0/IContexthubCallback;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/contexthub/V1_0/IContexthubCallback;
    ...
    invoke-static {v0}, Landroid/hardware/contexthub/V1_0/IContexthubCallback;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/contexthub/V1_0/IContexthubCallback;
