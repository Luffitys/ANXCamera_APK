...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/hardware/contexthub/V1_0/MemRange;->totalBytes:I

    iput v0, p0, Landroid/hardware/contexthub/V1_0/MemRange;->freeBytes:I

    iput v0, p0, Landroid/hardware/contexthub/V1_0/MemRange;->type:I
...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/contexthub/V1_0/MemRange;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/contexthub/V1_0/MemRange;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/contexthub/V1_0/MemRange;

    iget v3, p0, Landroid/hardware/contexthub/V1_0/MemRange;->totalBytes:I

    iget v4, v2, Landroid/hardware/contexthub/V1_0/MemRange;->totalBytes:I
    ...
    :cond_1b
    iget v3, p0, Landroid/hardware/contexthub/V1_0/MemRange;->freeBytes:I

    iget v4, v2, Landroid/hardware/contexthub/V1_0/MemRange;->freeBytes:I
    ...
    :cond_22
    iget v3, p0, Landroid/hardware/contexthub/V1_0/MemRange;->type:I

    iget v4, v2, Landroid/hardware/contexthub/V1_0/MemRange;->type:I
    ...
    :cond_29
    iget v3, p0, Landroid/hardware/contexthub/V1_0/MemRange;->flags:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget v4, v2, Landroid/hardware/contexthub/V1_0/MemRange;->flags:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v0, p0, Landroid/hardware/contexthub/V1_0/MemRange;->flags:I
