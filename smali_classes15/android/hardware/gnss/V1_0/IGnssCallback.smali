...
# static fields
.field public static final kInterfaceName:Ljava/lang/String; = "android.hardware.gnss@1.0::IGnssCallback"


# direct methods
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_0/IGnssCallback;
    .registers 8
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/gnss/V1_0/IGnssCallback;
    .registers 2
...
.method public static getService()Landroid/hardware/gnss/V1_0/IGnssCallback;
    .registers 1
...
.method public static getService(Ljava/lang/String;)Landroid/hardware/gnss/V1_0/IGnssCallback;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/gnss/V1_0/IGnssCallback;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Z)Landroid/hardware/gnss/V1_0/IGnssCallback;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public abstract gnssLocationCb(Landroid/hardware/gnss/V1_0/GnssLocation;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract gnssSetCapabilitesCb(I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract gnssSetSystemInfoCb(Landroid/hardware/gnss/V1_0/IGnssCallback$GnssSystemInfo;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract gnssStatusCb(B)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract gnssSvStatusCb(Landroid/hardware/gnss/V1_0/IGnssCallback$GnssSvStatus;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
