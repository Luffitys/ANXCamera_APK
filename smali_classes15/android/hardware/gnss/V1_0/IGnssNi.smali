...
# static fields
.field public static final kInterfaceName:Ljava/lang/String; = "android.hardware.gnss@1.0::IGnssNi"


# direct methods
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_0/IGnssNi;
    .registers 8
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/gnss/V1_0/IGnssNi;
    .registers 2
...
.method public static getService()Landroid/hardware/gnss/V1_0/IGnssNi;
    .registers 1
...
.method public static getService(Ljava/lang/String;)Landroid/hardware/gnss/V1_0/IGnssNi;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/gnss/V1_0/IGnssNi;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Z)Landroid/hardware/gnss/V1_0/IGnssNi;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public abstract respond(IB)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setCallback(Landroid/hardware/gnss/V1_0/IGnssNiCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
