...
# static fields
.field public static final kInterfaceName:Ljava/lang/String; = "android.hardware.gnss@1.0::IAGnssRil"


# direct methods
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_0/IAGnssRil;
    .registers 8
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/gnss/V1_0/IAGnssRil;
    .registers 2
...
.method public static getService()Landroid/hardware/gnss/V1_0/IAGnssRil;
    .registers 1
...
.method public static getService(Ljava/lang/String;)Landroid/hardware/gnss/V1_0/IAGnssRil;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/gnss/V1_0/IAGnssRil;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Z)Landroid/hardware/gnss/V1_0/IAGnssRil;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public abstract setCallback(Landroid/hardware/gnss/V1_0/IAGnssRilCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setRefLocation(Landroid/hardware/gnss/V1_0/IAGnssRil$AGnssRefLocation;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setSetId(BLjava/lang/String;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract updateNetworkAvailability(ZLjava/lang/String;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract updateNetworkState(ZBZ)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
