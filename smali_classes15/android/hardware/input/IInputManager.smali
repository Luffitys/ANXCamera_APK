.class public interface abstract Landroid/hardware/input/IInputManager;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/hardware/input/IInputManager$Default;
    }
.end annotation
...
.method public abstract addPortAssociation(Ljava/lang/String;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract cancelVibrate(ILandroid/os/IBinder;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getKeyboardLayout(Ljava/lang/String;)Landroid/hardware/input/KeyboardLayout;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getKeyboardLayouts()[Landroid/hardware/input/KeyboardLayout;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getKeyboardLayoutsForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;)[Landroid/hardware/input/KeyboardLayout;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getPointerVisibility()Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract isMicMuted()I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract monitorGestureInput(Ljava/lang/String;I)Landroid/view/InputMonitor;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract notifyMouseAction(II)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract removePortAssociation(Ljava/lang/String;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setGamePointerIconType(I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setPointerVisibility(Z)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract tryPointerSpeed(I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract vibrate(I[JILandroid/os/IBinder;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
