...
.method private constructor <init>(Landroid/content/pm/ShortcutInfo$Builder;)V
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mContext:Landroid/content/Context;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mId:Ljava/lang/String;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mActivity:Landroid/content/ComponentName;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mIcon:Landroid/graphics/drawable/Icon;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mTitle:Ljava/lang/CharSequence;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mTitleResId:I
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mText:Ljava/lang/CharSequence;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mTextResId:I
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mDisabledMessage:Ljava/lang/CharSequence;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mDisabledMessageResId:I
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mCategories:Ljava/util/Set;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mIntents:[Landroid/content/Intent;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mPersons:[Landroid/app/Person;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mIsLongLived:Z
    ...
    :cond_7f
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mRank:I
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mExtras:Landroid/os/PersistableBundle;
    ...
    # getter for: Landroid/content/pm/ShortcutInfo$Builder;->mLocusId:Landroid/content/LocusId;
