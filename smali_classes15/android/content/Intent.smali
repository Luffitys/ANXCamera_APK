...
.method private static getIntentOld(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    if-eq v8, v10, :cond_1fd

    :goto_db
    if-ge v0, v8, :cond_205
    ...
    if-le v12, v13, :cond_1f5

    if-ge v0, v8, :cond_1f5
    ...
    if-eq v13, v0, :cond_1a3

    const/16 v0, 0x69

    if-eq v13, v0, :cond_195
    ...
    packed-switch v13, :pswitch_data_22a
    ...
    :try_end_132
    .catch Ljava/lang/NumberFormatException; {:try_start_12e .. :try_end_132} :catch_13e
    ...
    throw v0
    :try_end_138
    .catch Ljava/lang/NumberFormatException; {:try_start_134 .. :try_end_138} :catch_138
    ...
    iget-object v0, v6, Landroid/content/Intent;->mExtras:Landroid/os/Bundle;
    :try_end_149
    .catch Ljava/lang/NumberFormatException; {:try_start_147 .. :try_end_149} :catch_154
    ...
    :try_end_1cc
    .catch Ljava/lang/NumberFormatException; {:try_start_14b .. :try_end_1cc} :catch_1e6
...
.method public static parseCommandArgs(Landroid/os/ShellCommand;Landroid/content/Intent$CommandOptionHandler;)Landroid/content/Intent;
    ...
    sparse-switch v13, :sswitch_data_74a
    ...
    packed-switch v8, :pswitch_data_824
    ...
    move-result v10
    :try_end_42f
    .catch Ljava/lang/NumberFormatException; {:try_start_427 .. :try_end_42f} :catch_436
    ...
    :sswitch_data_74a
    .sparse-switch
        -0x7ffea226 -> :sswitch_28d
        -0x7e40bfdd -> :sswitch_282
        -0x61305b9a -> :sswitch_277
        -0x4aae571d -> :sswitch_26c
        -0x3fbe74d1 -> :sswitch_261
        -0x328eb9b9 -> :sswitch_256
        -0x31a9343b -> :sswitch_24b
        -0x2f378b56 -> :sswitch_240
        -0x2e804d8f -> :sswitch_235
        0x5d4 -> :sswitch_22a
        0x5d6 -> :sswitch_21f
        0x5d7 -> :sswitch_214
        0x5d8 -> :sswitch_209
        ...
        0x5e3 -> :sswitch_1da
        0x5e7 -> :sswitch_1cf
        0x152a41 -> :sswitch_1c3
        0x152a44 -> :sswitch_1b8
        0x152a47 -> :sswitch_1ac
        0x152a4e -> :sswitch_1a1
        0x152a50 -> :sswitch_195
        0x152a55 -> :sswitch_189
        0x2901df0 -> :sswitch_17d
        0x2901e40 -> :sswitch_171
        0x2901e9d -> :sswitch_165
        0x2901efa -> :sswitch_159
        0x2901fd3 -> :sswitch_14d
        0x2901fe0 -> :sswitch_142
        0x41eb1c6 -> :sswitch_136
        0x54a2ed6 -> :sswitch_12a
        0xb611ab9 -> :sswitch_11e
        0xe1b6a37 -> :sswitch_112
        0x1998b94a -> :sswitch_106
        0x1a0135d9 -> :sswitch_fa
        0x1a23762e -> :sswitch_ee
        0x1f699c40 -> :sswitch_e2
        0x22987a20 -> :sswitch_d6
        0x2caeb912 -> :sswitch_ca
        0x2e337d40 -> :sswitch_be
        0x422c3bb1 -> :sswitch_b4
        0x47f6597f -> :sswitch_a8
...
.method public static parseUri(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    move-result v3
    :try_end_9
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_5 .. :try_end_9} :catch_35d
    ...
    :try_end_1e
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_11 .. :try_end_1e} :catch_35d
    ...
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_1f .. :try_end_26} :catch_35d
    ...
    move-result-object v11
    :try_end_69
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_29 .. :try_end_69} :catch_35d
    ...
    move-result v5
    :try_end_2b9
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_74 .. :try_end_2b9} :catch_35d
    ...
    move-result v0
    :try_end_348
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_2bd .. :try_end_348} :catch_35d
    ...
    :try_end_350
    .catch Ljava/lang/IllegalArgumentException; {:try_start_34a .. :try_end_350} :catch_351
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_34a .. :try_end_350} :catch_35d
    ...
    throw v3
    :try_end_35c
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_352 .. :try_end_35c} :catch_35d
...
.method public migrateExtraStreamToClipData(Landroid/content/Context;)Z
    ...
    move-result v3
    :try_end_31
    .catch Ljava/lang/ClassCastException; {:try_start_23 .. :try_end_31} :catch_33
    ...
    move-result v5
    :try_end_4a
    .catch Ljava/lang/ClassCastException; {:try_start_34 .. :try_end_4a} :catch_4f
    ...
    :try_end_8f
    .catch Ljava/lang/ClassCastException; {:try_start_61 .. :try_end_8f} :catch_90
    ...
    invoke-virtual {p0, v8}, Landroid/content/Intent;->addFlags(I)Landroid/content/Intent;
    :try_end_f5
    .catch Ljava/lang/ClassCastException; {:try_start_9b .. :try_end_f5} :catch_f7
    ...
    check-cast v3, Landroid/net/Uri;
    :try_end_105
    .catch Ljava/lang/ClassCastException; {:try_start_ff .. :try_end_105} :catch_11d
...
.method public prepareToLeaveProcess(Z)V
    ...
    :sswitch_c5
    const-string v6, "miui.intent.action.MEDIA_SCANNER_SCAN_FOLDER"
    ...
    :sswitch_data_1da
    .sparse-switch
        -0x78257653 -> :sswitch_119
        -0x6cb4d57b -> :sswitch_10f
        -0x6342a1e0 -> :sswitch_105
        -0x5a4113c8 -> :sswitch_fb
        -0x4418042d -> :sswitch_f0
        -0x39738481 -> :sswitch_e6
        -0x3032f575 -> :sswitch_db
        -0x254e496f -> :sswitch_d0
        -0xac540d0 -> :sswitch_c5
        0xf54386e -> :sswitch_ba
        0x187b165e -> :sswitch_af
        0x22b70ddb -> :sswitch_a3
        0x32c98ebd -> :sswitch_99
        0x543610e0 -> :sswitch_8d
        0x5559c83a -> :sswitch_81
        0x5f557da2 -> :sswitch_75
        0x7277a986 -> :sswitch_69
        0x751aa7fa -> :sswitch_5e
        0x79e65f52 -> :sswitch_53
    .end sparse-switch
