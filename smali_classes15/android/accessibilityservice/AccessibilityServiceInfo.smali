...
.method public constructor <init>(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)V
    ...
    :try_end_21
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_17 .. :try_end_21} :catch_158
    .catchall {:try_start_17 .. :try_end_21} :catchall_156
    ...
    const-string v9, "accessibility-service"
    ...
    invoke-virtual {v0, v10}, Landroid/content/pm/PackageManager;->getResourcesForApplication(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/Resources;

    move-result-object v10

    sget-object v11, Lcom/android/internal/R$styleable;->AccessibilityService:[I

    invoke-virtual {v10, v9, v11}, Landroid/content/res/Resources;->obtainAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    iput v12, v1, Landroid/accessibilityservice/AccessibilityServiceInfo;->eventTypes:I
    ...
    invoke-virtual {v11, v15, v13}, Landroid/content/res/TypedArray;->getInt(II)I
    ...
    invoke-virtual {v11, v15, v13}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {v11, v14, v13}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    iput v6, v1, Landroid/accessibilityservice/AccessibilityServiceInfo;->mCapabilities:I

    :cond_b0
    const/16 v6, 0xb

    invoke-virtual {v11, v6, v13}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v6

    if-eqz v6, :cond_bd

    iget v6, v1, Landroid/accessibilityservice/AccessibilityServiceInfo;->mCapabilities:I
    ...
    iget v13, v6, Landroid/util/TypedValue;->resourceId:I

    iput v13, v1, Landroid/accessibilityservice/AccessibilityServiceInfo;->mDescriptionResId:I
    ...
    :cond_110
    invoke-virtual {v11, v7}, Landroid/content/res/TypedArray;->peekValue(I)Landroid/util/TypedValue;
    ...
    iput-object v13, v1, Landroid/accessibilityservice/AccessibilityServiceInfo;->mNonLocalizedSummary:Ljava/lang/String;
    ...
    iput v7, v1, Landroid/accessibilityservice/AccessibilityServiceInfo;->mAnimatedImageRes:I
    ...
    :try_end_148
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_31 .. :try_end_148} :catch_158
    .catchall {:try_start_31 .. :try_end_148} :catchall_156
    ...
    throw v6
    :try_end_156
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_14e .. :try_end_156} :catch_158
    ...
    throw v5
    :try_end_172
    .catchall {:try_start_159 .. :try_end_172} :catchall_156
