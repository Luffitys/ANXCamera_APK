...
# static fields
.field public static sDefaultImpl:Landroid/app/blob/IBlobStoreSession;
...
.method public abandon()V
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->abandon()V
    :try_end_25
...
.method public allowPackageAccess(Ljava/lang/String;[B)V
    ...
    invoke-interface {v3, p1, p2}, Landroid/app/blob/IBlobStoreSession;->allowPackageAccess(Ljava/lang/String;[B)V
    :try_end_2a
...
.method public allowPublicAccess()V
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->allowPublicAccess()V
    :try_end_24
...
.method public allowSameSignatureAccess()V
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->allowSameSignatureAccess()V
    :try_end_24
    .catchall {:try_start_8 .. :try_end_24} :catchall_36
...
.method public close()V
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->close()V
    :try_end_25
    .catchall {:try_start_8 .. :try_end_25} :catchall_37
...
.method public commit(Landroid/app/blob/IBlobCommitCallback;)V
    ...
    invoke-interface {v3, p1}, Landroid/app/blob/IBlobStoreSession;->commit(Landroid/app/blob/IBlobCommitCallback;)V
    :try_end_30
...
.method public getSize()J
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->getSize()J
...
.method public isPackageAccessAllowed(Ljava/lang/String;[B)Z
    ...
    invoke-interface {v3, p1, p2}, Landroid/app/blob/IBlobStoreSession;->isPackageAccessAllowed(Ljava/lang/String;[B)Z
...
.method public isPublicAccessAllowed()Z
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->isPublicAccessAllowed()Z
...
.method public isSameSignatureAccessAllowed()Z
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->isSameSignatureAccessAllowed()Z
...
.method public openRead()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-interface {v3}, Landroid/app/blob/IBlobStoreSession;->openRead()Landroid/os/ParcelFileDescriptor;
...
.method public openWrite(JJ)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-interface {v3, p1, p2, p3, p4}, Landroid/app/blob/IBlobStoreSession;->openWrite(JJ)Landroid/os/ParcelFileDescriptor;
