...
.method constructor <init>(Landroid/accounts/AccountManager;Landroid/os/Handler;Landroid/accounts/AccountManagerCallback;Landroid/accounts/Account;Landroid/os/UserHandle;Landroid/os/UserHandle;)V
    ...
    iput-object p4, p0, Landroid/accounts/AccountManager$11;->val$account:Landroid/accounts/Account;

    iput-object p5, p0, Landroid/accounts/AccountManager$11;->val$fromUser:Landroid/os/UserHandle;

    iput-object p6, p0, Landroid/accounts/AccountManager$11;->val$toUser:Landroid/os/UserHandle;
...
.method public bridge synthetic bundleToResult(Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroid/accounts/AccountManager$11;->bundleToResult(Landroid/os/Bundle;)Ljava/lang/Boolean;
...
.method public doWork()V
    ...
    iget-object v3, p0, Landroid/accounts/AccountManager$11;->val$fromUser:Landroid/os/UserHandle;

    invoke-virtual {v3}, Landroid/os/UserHandle;->getIdentifier()I

    move-result v3

    iget-object v4, p0, Landroid/accounts/AccountManager$11;->val$toUser:Landroid/os/UserHandle;
